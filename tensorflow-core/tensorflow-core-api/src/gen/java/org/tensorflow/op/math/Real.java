 ...
 */
@Operator(group = "math")
public final class Real<U extends Tensor & TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends Tensor & TNumber, T extends Tensor> Real<U> create(Scope scope, Operand<T> input, DataType<U> Tout) {
   ...
   */
  @Endpoint(describeByClass = true)
  public static <T extends Tensor> Real<TFloat32> create(Scope scope, Operand<T> input) {
