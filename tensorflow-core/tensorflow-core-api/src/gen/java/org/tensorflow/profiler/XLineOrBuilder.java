...
public interface XLineOrBuilder extends
   ...
   */
  java.util.List<org.tensorflow.profiler.XEvent> 
      getEventsList();
  /**
   * <pre>
   * XEvents within the same XLine should not overlap in time, but they can be
   ...
   * <code>repeated .tensorflow.profiler.XEvent events = 4;</code>
   */
  org.tensorflow.profiler.XEvent getEvents(int index);
  /**
   * <pre>
   * XEvents within the same XLine should not overlap in time, but they can be
   * nested.
   ...
   * <code>repeated .tensorflow.profiler.XEvent events = 4;</code>
   */
  java.util.List<? extends org.tensorflow.profiler.XEventOrBuilder> 
   ...
   * <code>repeated .tensorflow.profiler.XEvent events = 4;</code>
   */
  org.tensorflow.profiler.XEventOrBuilder getEventsOrBuilder(
      int index);
}
