...
public final class Irfft<U extends TNumber> extends PrimitiveOp implements Operand<U> {
   ...
   * @return a new instance of Irfft
   */
  public static <T extends TType> Irfft<TFloat> create(Scope scope, Operand<T> input, Operand<TInt32> fftLength) {
