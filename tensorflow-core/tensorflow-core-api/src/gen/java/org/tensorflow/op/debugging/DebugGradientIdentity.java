...
@OpMetadata(
    ...
    inputsClass = DebugGradientIdentity.Inputs.class
)
public final class DebugGradientIdentity<T extends TType> extends RawOp implements Operand<T> {
  ...
  public DebugGradientIdentity(Operation operation) {
   ...
   * @param <T> data type for {@code DebugGradientIdentity} output and operands
  ...
  public static <T extends TType> DebugGradientIdentity<T> create(Scope scope, Operand<T> input) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "DebugGradientIdentity");
  ...
  @OpInputsMetadata(
      outputsClass = DebugGradientIdentity.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<DebugGradientIdentity<T>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new DebugGradientIdentity<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
