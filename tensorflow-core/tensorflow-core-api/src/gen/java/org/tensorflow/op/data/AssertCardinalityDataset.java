...
public final class AssertCardinalityDataset extends RawOp implements Operand<TType> {
  ...
  public static class Inputs extends RawOpInputs<AssertCardinalityDataset> {
     ...
     */
    public final Operand<TInt64> cardinality;
    ...
    public Inputs(GraphOperation op) {
      super(new AssertCardinalityDataset(op), op, Arrays.asList("output_types", "output_shapes"));
      int inputIndex = 0;
      inputDataset = (Operand<? extends TType>) op.input(inputIndex++);
      cardinality = (Operand<TInt64>) op.input(inputIndex++);
