...
public final class Solve<T> extends PrimitiveOp implements Operand<T> {
   ...
   */
  public static <T> Solve<T> create(Scope scope, Operand<T> matrix, Operand<T> rhs, Options... options) {
