 ...
 */
public final class QuantizedConv2DWithBiasAndRelu<V extends Tensor> extends RawOp {
  ...
  public static <V extends Tensor, T extends Tensor, U extends Tensor> QuantizedConv2DWithBiasAndRelu<V> create(Scope scope, Operand<T> input, Operand<U> filter, Operand<TFloat32> bias, Operand<TFloat32> minInput, Operand<TFloat32> maxInput, Operand<TFloat32> minFilter, Operand<TFloat32> maxFilter, DataType<V> outType, List<Long> strides, String padding, Options... options) {
    ...
    return new QuantizedConv2DWithBiasAndRelu<V>(opBuilder.build());
  }
