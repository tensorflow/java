...
public final class LogUniformCandidateSampler extends RawOp {
  ...
  public static LogUniformCandidateSampler create(Scope scope, Operand<TInt64> trueClasses,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LogUniformCandidateSampler");
  ...
  public static class Inputs extends RawOpInputs<LogUniformCandidateSampler> {
    ...
    public Inputs(GraphOperation op) {
      super(new LogUniformCandidateSampler(op), op, Arrays.asList("num_true", "num_sampled", "unique", "range_max", "seed", "seed2"));
      int inputIndex = 0;
