...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override public org.tensorflow.proto.util.WorkerHealth getHealthStatus() {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              org.tensorflow.proto.util.Event m =
                  input.readMessage(
                      org.tensorflow.proto.util.Event.parser(),
                      extensionRegistry);
              if (workerLogBuilder_ == null) {
                ensureWorkerLogIsMutable();
                workerLog_.add(m);
