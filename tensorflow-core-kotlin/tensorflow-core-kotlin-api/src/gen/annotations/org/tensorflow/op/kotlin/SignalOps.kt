...
public class SignalOps(
  ...
  public fun batchFft(input: Operand<*>): BatchFft = java.batchFft(input)

  public fun batchFft2d(input: Operand<*>): BatchFft2d = java.batchFft2d(input)

  public fun batchFft3d(input: Operand<*>): BatchFft3d = java.batchFft3d(input)

  public fun batchIfft(input: Operand<*>): BatchIfft = java.batchIfft(input)

  public fun batchIfft2d(input: Operand<*>): BatchIfft2d = java.batchIfft2d(input)

  public fun batchIfft3d(input: Operand<*>): BatchIfft3d = java.batchIfft3d(input)

  public fun <T : TType> fft(input: Operand<T>): Fft<T> = java.fft<T>(input)

  public fun <T : TType> fft2d(input: Operand<T>): Fft2d<T> = java.fft2d<T>(input)

  public fun <T : TType> fft3d(input: Operand<T>): Fft3d<T> = java.fft3d<T>(input)

  public fun <T : TType> ifft(input: Operand<T>): Ifft<T> = java.ifft<T>(input)

  public fun <T : TType> ifft2d(input: Operand<T>): Ifft2d<T> = java.ifft2d<T>(input)

  public fun <T : TType> ifft3d(input: Operand<T>): Ifft3d<T> = java.ifft3d<T>(input)

  public fun <T : TType> irfft(input: Operand<T>, fftLength: Operand<TInt32>): Irfft<TFloat32> =
      java.irfft<T>(input, fftLength)

  public fun <U : TNumber, T : TType> irfft(
    input: Operand<T>,
    fftLength: Operand<TInt32>,
    Treal: DataType<U>
  ): Irfft<U> = java.irfft<U, T>(input, fftLength, Treal)

  public fun <T : TType> irfft2d(input: Operand<T>, fftLength: Operand<TInt32>): Irfft2d<TFloat32> =
      java.irfft2d<T>(input, fftLength)

  public fun <U : TNumber, T : TType> irfft2d(
    input: Operand<T>,
    fftLength: Operand<TInt32>,
    Treal: DataType<U>
  ): Irfft2d<U> = java.irfft2d<U, T>(input, fftLength, Treal)

  public fun <T : TType> irfft3d(input: Operand<T>, fftLength: Operand<TInt32>): Irfft3d<TFloat32> =
      java.irfft3d<T>(input, fftLength)

  public fun <U : TNumber, T : TType> irfft3d(
    input: Operand<T>,
    fftLength: Operand<TInt32>,
    Treal: DataType<U>
  ): Irfft3d<U> = java.irfft3d<U, T>(input, fftLength, Treal)

  public fun <U : TType, T : TNumber> rfft(
    input: Operand<T>,
    fftLength: Operand<TInt32>,
    Tcomplex: DataType<U>
  ): Rfft<U> = java.rfft<U, T>(input, fftLength, Tcomplex)

  public fun <U : TType, T : TNumber> rfft2d(
    input: Operand<T>,
    fftLength: Operand<TInt32>,
    Tcomplex: DataType<U>
  ): Rfft2d<U> = java.rfft2d<U, T>(input, fftLength, Tcomplex)

  public fun <U : TType, T : TNumber> rfft3d(
    input: Operand<T>,
    fftLength: Operand<TInt32>,
    Tcomplex: DataType<U>
  ): Rfft3d<U> = java.rfft3d<U, T>(input, fftLength, Tcomplex)
}
