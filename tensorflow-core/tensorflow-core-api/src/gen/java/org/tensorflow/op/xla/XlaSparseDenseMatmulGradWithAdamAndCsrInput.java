...
public final class XlaSparseDenseMatmulGradWithAdamAndCsrInput extends RawOp {
  ...
  public static class Inputs extends RawOpInputs<XlaSparseDenseMatmulGradWithAdamAndCsrInput> {
    ...
    public Inputs(GraphOperation op) {
      super(new XlaSparseDenseMatmulGradWithAdamAndCsrInput(op), op, Arrays.asList("use_sum_inside_sqrt", "beta1", "beta2", "epsilon", "clip_weight_min", "clip_weight_max", "table_name"));
      int inputIndex = 0;
