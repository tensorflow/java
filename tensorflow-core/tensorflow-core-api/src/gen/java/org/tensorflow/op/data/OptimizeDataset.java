...
public final class OptimizeDataset extends RawOp implements Operand<TType> {
  ...
  public static OptimizeDataset create(Scope scope, Operand<?> inputDataset, Operand<TString> optimizations, List<Class<?>> outputTypes, List<Shape> outputShapes, Options... options) {
    ...
    opBuilder.addInput(optimizations.asOutput(scope));
