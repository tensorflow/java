...
public final class LoadTPUEmbeddingStochasticGradientDescentParameters extends RawOp {
  ...
  public static LoadTPUEmbeddingStochasticGradientDescentParameters create(Scope scope,
      Operand<TFloat32> parameters, Long numShards, Long shardId, Options... options) {
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.LoadTPUEmbeddingStochasticGradientDescentParameters}
   */
  ...
  public static class Inputs extends RawOpInputs<LoadTPUEmbeddingStochasticGradientDescentParameters> {
    ...
    public Inputs(GraphOperation op) {
      super(new LoadTPUEmbeddingStochasticGradientDescentParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
