 ...
 */
@OpMetadata(
    opType = SparseSegmentSumGradV2.OP_NAME,
    inputsClass = SparseSegmentSumGradV2.Inputs.class
)
@Operator
public final class SparseSegmentSumGradV2<T extends TNumber, U extends TNumber> extends RawOp {
  /**
  ...
  public SparseSegmentSumGradV2(Operation operation) {
  ...
  public static <T extends TNumber, U extends TNumber> SparseSegmentSumGradV2<T, U> create(
      Scope scope, Operand<T> grad, Operand<U> indices, Operand<? extends TNumber> segmentIds,
      Operand<TInt32> denseOutputDim0) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "SparseSegmentSumGradV2");
    opBuilder.addInput(grad.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(segmentIds.asOutput());
    opBuilder.addInput(denseOutputDim0.asOutput());
    return new SparseSegmentSumGradV2<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = SparseSegmentSumGradV2.class
  )
  public static class Inputs<T extends TNumber, U extends TNumber> extends RawOpInputs<SparseSegmentSumGradV2<T, U>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new SparseSegmentSumGradV2<>(op), op, Arrays.asList("T", "Tidx", "Tsegmentids"));
      int inputIndex = 0;
