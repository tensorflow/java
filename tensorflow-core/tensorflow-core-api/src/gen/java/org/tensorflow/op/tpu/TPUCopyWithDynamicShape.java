 ...
 */
@OpMetadata(
    opType = TPUCopyWithDynamicShape.OP_NAME,
    inputsClass = TPUCopyWithDynamicShape.Inputs.class
)
@Operator(
    group = "tpu"
)
public final class TPUCopyWithDynamicShape extends RawOp implements Iterable<Operand<TType>> {
  ...
  public static TPUCopyWithDynamicShape create(Scope scope, Iterable<Operand<?>> tensors,
      Iterable<Operand<TInt32>> unpaddedSizes) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "TPUCopyWithDynamicShape");
  ...
  @OpInputsMetadata(
      outputsClass = TPUCopyWithDynamicShape.class
  )
  public static class Inputs extends RawOpInputs<TPUCopyWithDynamicShape> {
    ...
    public Inputs(GraphOperation op) {
      ...
      unpaddedSizes = Arrays.asList((Operand<TInt32>[]) op.inputList(inputIndex, unpaddedSizesLength));
