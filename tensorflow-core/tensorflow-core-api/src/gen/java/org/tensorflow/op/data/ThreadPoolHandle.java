...
public final class ThreadPoolHandle extends RawOp implements Operand<TType> {
   ...
   */
  public static final String OP_NAME = "ThreadPoolHandle";
  ...
  public static ThreadPoolHandle create(Scope scope, Long numThreads, String displayName,
      Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder(OP_NAME, scope.makeOpName("ThreadPoolHandle"));
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.data.ThreadPoolHandle}
   */
