...
public final class DoubleRawDataBuffer extends AbstractRawDataBuffer<Double, DoubleDataBuffer>
  ...
  public static DoubleDataBuffer wrap(double[] array, boolean readOnly) {
    return new DoubleRawDataBuffer(UnsafeMemoryHandle.of(UnsafeReference.get(), array), readOnly);
  }

  public static DoubleDataBuffer map(UnsafeReference unsafe, long address, long size, boolean readOnly) {
