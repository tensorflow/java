...
class InputSpecTest {
  ...
  public void testDefinedShape() {
    ...
    InputSpec instance = new InputSpec(InputSpec.Options.create().shape(expected));
    assertArrayEquals(expected.asArray(), instance.toShape().asArray());
  }

  @Test
  public void testDefinedRank() {
    InputSpec instance = new InputSpec(InputSpec.Options.create().rank(5));
  ...
  public void testUndefinedShapes() {
    InputSpec instance = new InputSpec(InputSpec.Options.create().maxRank(5));
    Shape genShaped = instance.toShape();
    assertTrue(genShaped.isUnknown());

    instance = new InputSpec(InputSpec.Options.create().minRank(5).maxRank(5));
