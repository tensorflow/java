 ...
 */
@Operator(group = "math")
public final class SquaredDifference<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> SquaredDifference<T> create(Scope scope, Operand<T> x, Operand<T> y) {
