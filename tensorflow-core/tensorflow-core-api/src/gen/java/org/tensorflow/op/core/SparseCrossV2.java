 ...
 */
@Operator
public final class SparseCrossV2 extends RawOp {
  ...
  public static SparseCrossV2 create(Scope scope, Iterable<Operand<TInt64>> indices, Iterable<Operand<?>> values, Iterable<Operand<TInt64>> shapes, Iterable<Operand<?>> denseInputs, Operand<TString> sep) {
    ...
    return new SparseCrossV2(opBuilder.build());
  }
