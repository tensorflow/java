...
public final class Cos<T extends TType> extends RawOp implements Operand<T> {
  ...
  @OpInputsMetadata(
      outputsClass = Cos.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<Cos<T>> {
    /**
     * The x input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Cos<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
