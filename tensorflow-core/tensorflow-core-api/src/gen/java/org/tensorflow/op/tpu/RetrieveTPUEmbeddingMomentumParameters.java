...
public final class RetrieveTPUEmbeddingMomentumParameters extends RawOp {
  ...
  public static RetrieveTPUEmbeddingMomentumParameters create(Scope scope, Long numShards,
      Long shardId, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingMomentumParameters");
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.RetrieveTPUEmbeddingMomentumParameters}
   */
  ...
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingMomentumParameters> {
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingMomentumParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
