...
public interface RemoteFusedGraphExecuteInfoOrBuilder extends
   ...
   * <code>.tensorflow.GraphDef remote_graph = 1;</code>
   */
  org.tensorflow.proto.framework.GraphDef getRemoteGraph();
  /**
   * <pre>
   * Definition of remote graph
   * </pre>
   ...
   * <code>.tensorflow.GraphDef remote_graph = 1;</code>
   */
  org.tensorflow.proto.framework.GraphDefOrBuilder getRemoteGraphOrBuilder();
   ...
   */
  java.util.List<org.tensorflow.proto.framework.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto> 
   ...
   * <code>repeated .tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto default_graph_input_tensor_shape = 6;</code>
   */
  org.tensorflow.proto.framework.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto getDefaultGraphInputTensorShape(int index);
  /**
   * <pre>
   * Optional: Default graph input tensor shape used to allocate memory
   * before executing op
   ...
   * <code>repeated .tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto default_graph_input_tensor_shape = 6;</code>
   */
  java.util.List<? extends org.tensorflow.proto.framework.RemoteFusedGraphExecuteInfo.TensorShapeTypeProtoOrBuilder> 
   ...
   * <code>repeated .tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto default_graph_input_tensor_shape = 6;</code>
   */
  org.tensorflow.proto.framework.RemoteFusedGraphExecuteInfo.TensorShapeTypeProtoOrBuilder getDefaultGraphInputTensorShapeOrBuilder(
      int index);
   ...
   * <code>repeated .tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto default_graph_output_tensor_shape = 7;</code>
   */
  org.tensorflow.proto.framework.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto getDefaultGraphOutputTensorShape(int index);
  /**
   * <pre>
   * Optional: Default graph input tensor shape used to allocate memory
   * before executing op
   ...
   * <code>repeated .tensorflow.RemoteFusedGraphExecuteInfo.TensorShapeTypeProto default_graph_output_tensor_shape = 7;</code>
   */
  org.tensorflow.proto.framework.RemoteFusedGraphExecuteInfo.TensorShapeTypeProtoOrBuilder getDefaultGraphOutputTensorShapeOrBuilder(
      int index);
}
