...
public final class QuantizedMatMulWithBiasAndRequantize<W extends TNumber> extends RawOp {
  ...
  public QuantizedMatMulWithBiasAndRequantize(Operation operation) {
  ...
  public static <W extends TNumber> QuantizedMatMulWithBiasAndRequantize<W> create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedMatMulWithBiasAndRequantize");
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedMatMulWithBiasAndRequantize.class
  )
  public static class Inputs extends RawOpInputs<QuantizedMatMulWithBiasAndRequantize<?>> {
    /**
     * The a input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedMatMulWithBiasAndRequantize<>(op), op, Arrays.asList("T1", "T2", "Tbias", "Toutput", "transpose_a", "transpose_b", "input_quant_mode"));
      int inputIndex = 0;
