  ...
  public void testCallAlpha0() {
    ...
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      ELU<TFloat32> instance =
          new ELU<>(alpha, TFloat32.class, Layer.Options.create().inputShape(Shape.of(2, 3, 4)));
  ...
  public void testCallAlphaMinus1() {
    ...
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      ELU<TFloat64> instance =
          new ELU<>(alpha, TFloat64.class, Layer.Options.create().inputShape(Shape.of(2, 3, 4)));
