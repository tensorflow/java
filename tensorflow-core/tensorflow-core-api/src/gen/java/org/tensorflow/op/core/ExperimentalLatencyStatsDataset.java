 ...
 */
public final class ExperimentalLatencyStatsDataset extends PrimitiveOp implements Operand<TType> {
   ...
   */
  public static ExperimentalLatencyStatsDataset create(Scope scope, Operand<?> inputDataset, Operand<TString> tag, List<DataType<?>> outputTypes, List<Shape> outputShapes) {
