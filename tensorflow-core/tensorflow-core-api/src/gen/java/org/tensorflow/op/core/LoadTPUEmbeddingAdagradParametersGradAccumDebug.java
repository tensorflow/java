 ...
 * executed.
 */
public final class LoadTPUEmbeddingAdagradParametersGradAccumDebug extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.LoadTPUEmbeddingAdagradParametersGradAccumDebug}
   */
   ...
   */
  public static LoadTPUEmbeddingAdagradParametersGradAccumDebug create(Scope scope, Operand<TFloat> parameters, Operand<TFloat> accumulators, Operand<TFloat> gradientAccumulators, Long numShards, Long shardId, Options... options) {
