...
import org.tensorflow.op.sparse.ConvertToListOfSparseCoreCooTensors;
import org.tensorflow.op.sparse.ConvertToSparseCoreCsrWrappedCooTensor;
...
import org.tensorflow.op.sparse.GetStatsFromListOfSparseCoreCooTensors;
...
public final class SparseOps {
   ...
   */
  public ConvertToListOfSparseCoreCooTensors convertToListOfSparseCoreCooTensors(
    ...
    return ConvertToListOfSparseCoreCooTensors.create(scope, indicesOrRowSplits, values, weights, sampleCount, numScPerChip, rowOffset, colOffset, colShift, numScShards, stackedTableSampleCount, combiner);
  }
   ...
   */
  public ConvertToSparseCoreCsrWrappedCooTensor convertToSparseCoreCsrWrappedCooTensor(
    ...
    return ConvertToSparseCoreCsrWrappedCooTensor.create(scope, sortedRowIdsList, sortedColIdsList, sortedGainsList, idCountsList, splits, sampleCountPerSc, numReplica, maxMinibatchesPerSc, maxIdsPerChipPerSample, tableVocabSize, featureWidth, tableName, allowIdDropping);
  }
   ...
   */
  public GetStatsFromListOfSparseCoreCooTensors getStatsFromListOfSparseCoreCooTensors(
      ...
      String tableName) {
    return GetStatsFromListOfSparseCoreCooTensors.create(scope, rowIdsList, colIdsList, gainsList, sampleCountList, colOffsetList, numReplica, tableVocabSize, featureWidth, numScPerChip, tableName);
  }
