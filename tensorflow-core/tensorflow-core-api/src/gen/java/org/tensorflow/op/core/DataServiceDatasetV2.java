...
public final class DataServiceDatasetV2 extends RawOp implements Operand<TType> {
  ...
  private DataServiceDatasetV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
  ...
  public static DataServiceDatasetV2 create(Scope scope, Operand<TInt64> datasetId,
    ...
    OperationBuilder opBuilder = scope.env().opBuilder("DataServiceDatasetV2", scope.makeOpName("DataServiceDatasetV2"));
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.DataServiceDatasetV2}
   */
