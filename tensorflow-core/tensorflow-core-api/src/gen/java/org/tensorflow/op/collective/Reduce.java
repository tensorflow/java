...
public final class Reduce<T extends TNumber> extends RawOp implements Operand<T> {
  ...
  public static class Inputs<T extends TNumber> extends RawOpInputs<Reduce<T>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Reduce<>(op), op, Arrays.asList("T", "group_size", "group_key", "instance_key", "merge_op", "final_op", "subdiv_offsets", "wait_for", "communication_hint", "timeout_seconds"));
      int inputIndex = 0;
