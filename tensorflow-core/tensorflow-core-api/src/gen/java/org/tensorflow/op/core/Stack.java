 ...
 */
@Operator
public final class Stack<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Stack<T> create(Scope scope, Iterable<Operand<T>> values, Options... options) {
