...
public final class StatefulStandardNormal<U extends TType> extends PrimitiveOp implements Operand<U> {
   ...
   */
  public static <U extends TType, T extends TType> StatefulStandardNormal<U> create(Scope scope, Operand<?> resource, Operand<TInt64> algorithm, Operand<T> shape, DataType<U> dtype) {
   ...
   * @return a new instance of StatefulStandardNormal
   */
  public static <T extends TType> StatefulStandardNormal<TFloat> create(Scope scope, Operand<?> resource, Operand<TInt64> algorithm, Operand<T> shape) {
