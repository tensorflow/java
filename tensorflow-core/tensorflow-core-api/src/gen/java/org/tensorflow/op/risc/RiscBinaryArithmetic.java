 ...
 */
@OpMetadata(
    opType = RiscBinaryArithmetic.OP_NAME,
    inputsClass = RiscBinaryArithmetic.Inputs.class
)
public final class RiscBinaryArithmetic<T extends TNumber> extends RawOp implements Operand<T> {
  ...
  public RiscBinaryArithmetic(Operation operation) {
  ...
  public static <T extends TNumber> RiscBinaryArithmetic<T> create(Scope scope, Operand<T> x,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RiscBinaryArithmetic");
  ...
  @OpInputsMetadata(
      outputsClass = RiscBinaryArithmetic.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<RiscBinaryArithmetic<T>> {
    /**
     * The x input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new RiscBinaryArithmetic<>(op), op, Arrays.asList("op_type", "T"));
      int inputIndex = 0;
