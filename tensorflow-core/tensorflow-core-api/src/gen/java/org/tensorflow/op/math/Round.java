...
@OpMetadata(
    ...
    inputsClass = Round.Inputs.class
)
@Operator(
    group = "math"
)
public final class Round<T extends TType> extends RawOp implements Operand<T> {
  ...
  public Round(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = Round.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<Round<T>> {
    /**
     * The x input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Round<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
