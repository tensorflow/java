 ...
 * executed.
 */
public final class LoadTPUEmbeddingADAMParametersGradAccumDebug extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.LoadTPUEmbeddingADAMParametersGradAccumDebug}
   */
