 ...
 *   numbers of pixels.
 */
public final class ExtractGlimpseV2 extends RawOp implements Operand<TFloat32> {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.ExtractGlimpseV2}
   */
   ...
   * @return a new instance of ExtractGlimpseV2
   */
  @Endpoint(describeByClass = true)
  public static ExtractGlimpseV2 create(Scope scope, Operand<TFloat32> input, Operand<TInt32> size, Operand<TFloat32> offsets, Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder("ExtractGlimpseV2", scope.makeOpName("ExtractGlimpseV2"));
    ...
    return new ExtractGlimpseV2(opBuilder.build());
  }
  ...
  private ExtractGlimpseV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
