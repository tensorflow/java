...
public class Flatten<T extends TFloating> extends Layer<T> {
   ...
   */
  public Flatten(Class<T> type) {
    this(null, TensorFormat.NHWC, type, null);
  }
   ...
   * @param type the data type for the layer's weights and computation.
   */
  public Flatten(String name, Class<T> type) {
    this(name, TensorFormat.NHWC, type, null);
  }
   ...
   * @param type the data type for the layer's weights and computation.
   */
  public Flatten(TensorFormat dataFormat, Class<T> type) {
    this(null, dataFormat, type, null);
  }
   ...
   */
  public Flatten(TensorFormat dataFormat, Class<T> type, Options options) {
    this(null, dataFormat, type, options);
  }
   ...
   * @param type the data type for the layer's weights and computation.
   */
  public Flatten(String name, TensorFormat dataFormat, Class<T> type) {
    this(name, dataFormat, type, null);
  }
  /**
   * Creates a Flatten Layer
   *
   ...
   * @param options the layer's options.
   */
  public Flatten(String name, TensorFormat dataFormat, Class<T> type, Options options) {
