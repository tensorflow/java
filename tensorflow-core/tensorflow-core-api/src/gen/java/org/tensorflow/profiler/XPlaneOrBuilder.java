...
public interface XPlaneOrBuilder extends
   ...
   */
  java.util.List<org.tensorflow.profiler.XLine> 
      getLinesList();
  /**
   * <pre>
   * Parallel timelines grouped in this plane. XLines with the same id
   ...
   * <code>repeated .tensorflow.profiler.XLine lines = 3;</code>
   */
  org.tensorflow.profiler.XLine getLines(int index);
  /**
   * <pre>
   * Parallel timelines grouped in this plane. XLines with the same id
   * are effectively the same timeline.
   ...
   * <code>repeated .tensorflow.profiler.XLine lines = 3;</code>
   */
  java.util.List<? extends org.tensorflow.profiler.XLineOrBuilder> 
   ...
   * <code>repeated .tensorflow.profiler.XLine lines = 3;</code>
   */
  org.tensorflow.profiler.XLineOrBuilder getLinesOrBuilder(
      int index);
  ...
  java.util.Map<java.lang.Long, org.tensorflow.profiler.XEventMetadata>
  getEventMetadata();
  /**
   * <pre>
   * XEventMetadata map, each entry uses the XEventMetadata.id as key. This map
  ...
  org.tensorflow.profiler.XEventMetadata getEventMetadataOrDefault(
      long key,
  ...
  org.tensorflow.profiler.XEventMetadata getEventMetadataOrThrow(
      long key);
   ...
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.Long, org.tensorflow.profiler.XStatMetadata>
  getStatMetadata();
  /**
   * <pre>
   * XStatMetadata map, each entry uses the XStatMetadata.id as key. This map
  ...
  org.tensorflow.profiler.XStatMetadata getStatMetadataOrDefault(
      long key,
  ...
  org.tensorflow.profiler.XStatMetadata getStatMetadataOrThrow(
      long key);
