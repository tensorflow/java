 ...
 */
@Operator(group = "math")
public final class Maximum<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> Maximum<T> create(Scope scope, Operand<T> x, Operand<T> y) {
