...
public final class XlaSparseDenseMatmulGradWithAdamAndStaticBufferSize extends RawOp {
  ...
  public static class Inputs extends RawOpInputs<XlaSparseDenseMatmulGradWithAdamAndStaticBufferSize> {
    ...
    public Inputs(GraphOperation op) {
      super(new XlaSparseDenseMatmulGradWithAdamAndStaticBufferSize(op), op, Arrays.asList("use_sum_inside_sqrt", "beta1", "beta2", "epsilon", "clip_weight_min", "clip_weight_max", "max_ids_per_sparse_core", "max_unique_ids_per_sparse_core", "table_name", "num_sparsecores_per_device"));
      int inputIndex = 0;
