 ...
 */
public class MeanAbsolutePercentageError<T extends TNumber> extends MeanBaseMetricWrapper<T>
  ...
  public <U extends TNumber> Operand<U> call(
    ...
    return Losses.meanAbsolutePercentageError(tf, tLabels, tPredictions);
  }
}
