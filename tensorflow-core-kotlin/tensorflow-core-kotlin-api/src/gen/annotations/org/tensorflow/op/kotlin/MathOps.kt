...
public class MathOps(
	...
	public fun <T : TNumber> floorMod(x: Operand<T>, y: Operand<T>): FloorMod<T> = java.floorMod<T>(	
		x,
		y
		)
	...
	public fun <T : TNumber> lessEqual(x: Operand<T>, y: Operand<T>): LessEqual = java.lessEqual<T>(	
		x,
		y
		)
