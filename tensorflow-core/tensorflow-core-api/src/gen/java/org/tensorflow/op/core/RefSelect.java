 ...
 */
@Operator
public final class RefSelect<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> RefSelect<T> create(Scope scope, Operand<TInt32> index, Iterable<Operand<T>> inputs) {
