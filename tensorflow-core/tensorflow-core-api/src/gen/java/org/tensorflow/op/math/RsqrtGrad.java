 ...
 */
public final class RsqrtGrad<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> RsqrtGrad<T> create(Scope scope, Operand<T> y, Operand<T> dy) {
