 ...
 */
@OpMetadata(
    opType = RiscBitcast.OP_NAME,
    inputsClass = RiscBitcast.Inputs.class
)
public final class RiscBitcast<U extends TType> extends RawOp implements Operand<U> {
  ...
  public RiscBitcast(Operation operation) {
  ...
  public static <U extends TType> RiscBitcast<U> create(Scope scope, Operand<? extends TType> x,
      Class<U> DstT) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RiscBitcast");
  ...
  @OpInputsMetadata(
      outputsClass = RiscBitcast.class
  )
