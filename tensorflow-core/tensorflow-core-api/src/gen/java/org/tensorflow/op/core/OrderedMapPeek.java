...
public final class OrderedMapPeek extends RawOp implements Iterable<Operand<TType>> {
  ...
  public static OrderedMapPeek create(Scope scope, Operand<TInt64> key, Operand<TInt32> indices,
      List<Class<? extends TType>> dtypes, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "OrderedMapPeek");
  ...
  public static class Inputs extends RawOpInputs<OrderedMapPeek> {
    ...
    public Inputs(GraphOperation op) {
      super(new OrderedMapPeek(op), op, Arrays.asList("capacity", "memory_limit", "dtypes", "container", "shared_name"));
      int inputIndex = 0;
