...
@OpMetadata(
    ...
    inputsClass = Relu6.Inputs.class
)
@Operator(
    group = "nn"
)
public final class Relu6<T extends TNumber> extends RawOp implements Operand<T> {
  ...
  public Relu6(Operation operation) {
  ...
  public static <T extends TNumber> Relu6<T> create(Scope scope, Operand<T> features) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "Relu6");
  ...
  @OpInputsMetadata(
      outputsClass = Relu6.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<Relu6<T>> {
    /**
     * The features input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Relu6<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
