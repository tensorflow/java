 ...
 */
@Operator
public final class ReduceSum<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber> ReduceSum<T> create(Scope scope, Operand<T> input, Operand<U> axis, Options... options) {
