...
public class GaussianDropout<T extends TFloating> extends Layer<T> {
   ...
   */
  public GaussianDropout(float rate, long seed, Class<T> type) {

    this(null, rate, seed, type, null);
  }
   ...
   */
  public GaussianDropout(float rate, long seed, Class<T> type, Options options) {

    this(null, rate, seed, type, options);
  }
   ...
   * @param type the data type for the weights and computation
   */
  public GaussianDropout(String name, float rate, long seed, Class<T> type) {
    this(name, rate, seed, type, null);
  }
   ...
   * @param options the layer's options.
   */
  public GaussianDropout(String name, float rate, long seed, Class<T> type, Options options) {
