...
public abstract class DoubleNdArrayTestBase extends NdArrayTestBase<Double> {
  ...
  public void iteratePrimitiveElements() {
    ...
    matrix3d.scalars().forEachIndexed((coords, scalar) -> scalar.setDouble((double) coords[2]));
    ...
    matrix3d.elements(1).forEach(vector -> vector.set(NdArrays.vectorOf(5.0, 6.0, 7.0, 8.0, 9.0)));
