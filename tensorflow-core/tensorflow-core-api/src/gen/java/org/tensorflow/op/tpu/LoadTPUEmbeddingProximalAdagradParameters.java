...
public final class LoadTPUEmbeddingProximalAdagradParameters extends RawOp {
  ...
  public static LoadTPUEmbeddingProximalAdagradParameters create(Scope scope,
      Operand<TFloat32> parameters, Operand<TFloat32> accumulators, Long numShards, Long shardId,
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LoadTPUEmbeddingProximalAdagradParameters");
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.LoadTPUEmbeddingProximalAdagradParameters}
   */
  ...
  public static class Inputs extends RawOpInputs<LoadTPUEmbeddingProximalAdagradParameters> {
    ...
    public Inputs(GraphOperation op) {
      super(new LoadTPUEmbeddingProximalAdagradParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
