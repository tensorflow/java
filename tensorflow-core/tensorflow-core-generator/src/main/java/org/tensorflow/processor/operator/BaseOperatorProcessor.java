...
public abstract class BaseOperatorProcessor<T> extends AbstractProcessor {
  ...
  protected static class OpsSpec {
    ...
    final List<OpMethod> methods;
    final List<OpsSpec> subGroups = new ArrayList<>();

    OpsSpec(String groupName, String fieldName, ClassName className, Collection<OpMethod> methods) {
  ...
  protected static final TypeName T_OP = ClassName.get("org.tensorflow.op", "Op");
  ...
  protected static final TypeName T_OPERATOR =
      ClassName.get("org.tensorflow.op.annotation", "Operator");
  protected static final TypeName T_ENDPOINT =
      ClassName.get("org.tensorflow.op.annotation", "Endpoint");
  protected static final TypeName T_SCOPE = ClassName.get("org.tensorflow.op", "Scope");
  protected static final TypeName T_EXEC_ENV =
      ClassName.get("org.tensorflow", "ExecutionEnvironment");
  protected static final TypeName T_EAGER_SESSION = ClassName.get("org.tensorflow", "EagerSession");
  protected static final TypeName T_STRING = ClassName.get(String.class);
