 ...
 */
@OpMetadata(
    opType = ResourceScatterAdd.OP_NAME,
    inputsClass = ResourceScatterAdd.Inputs.class
)
@Operator
public final class ResourceScatterAdd extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "ResourceScatterAdd";

  public ResourceScatterAdd(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = ResourceScatterAdd.class
  )
  public static class Inputs extends RawOpInputs<ResourceScatterAdd> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new ResourceScatterAdd(op), op, Arrays.asList("dtype", "Tindices"));
      int inputIndex = 0;
