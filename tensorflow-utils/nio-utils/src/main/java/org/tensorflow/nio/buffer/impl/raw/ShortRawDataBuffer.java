...
public final class ShortRawDataBuffer extends AbstractRawDataBuffer<Short, ShortDataBuffer>
  ...
  public static ShortDataBuffer wrap(short[] array, boolean readOnly) {
    return new ShortRawDataBuffer(UnsafeMemoryHandle.of(UNSAFE, array), readOnly);
  }

  public static ShortDataBuffer map(Unsafe unsafe, long address, long size, boolean readOnly) {
