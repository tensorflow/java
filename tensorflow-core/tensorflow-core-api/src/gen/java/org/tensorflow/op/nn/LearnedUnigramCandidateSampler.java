 ...
 */
@OpMetadata(
    opType = LearnedUnigramCandidateSampler.OP_NAME,
    inputsClass = LearnedUnigramCandidateSampler.Inputs.class
)
@Operator(
    group = "nn"
)
public final class LearnedUnigramCandidateSampler extends RawOp {
  ...
  public static LearnedUnigramCandidateSampler create(Scope scope, Operand<TInt64> trueClasses,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LearnedUnigramCandidateSampler");
  ...
  @OpInputsMetadata(
      outputsClass = LearnedUnigramCandidateSampler.class
  )
  public static class Inputs extends RawOpInputs<LearnedUnigramCandidateSampler> {
    /**
