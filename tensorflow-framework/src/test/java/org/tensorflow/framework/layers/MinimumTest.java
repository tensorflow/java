...
class MinimumTest {
  ...
  double[][][] xmin = {
    {
      {0.13570025, 0.28889298, 0.06648757, 0.58405729, 0.32654201},
      {0.18659685, 0.17123203, 0.62582661, 0.09510652, 0.58700802},
      {0.12527705, 0.37543824, 0.64915537, 0.31828287, 0.26400939},
      {0.76202298, 0.05605309, 0.0677271, 0.07027092, 0.29195821}
    },
    {
      {0.13023652, 0.10611362, 0.83370522, 0.71302943, 0.08126704},
      {0.48173969, 0.16509515, 0.21040572, 0.16864979, 0.70656624},
      {0.39645622, 0.35834793, 0.39924944, 0.31897888, 0.56743576},
      {0.36304201, 0.36696309, 0.60722209, 0.33104554, 0.11978174}
    }
  };
    ...
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      Input<TFloat64> i2 =
          new Input<>(
              ...
              TFloat64.class,
              Layer.Options.create().inputShape(Shape.of(4, 5)));
      Minimum<TFloat64> instance = new Minimum<>(tf, TFloat64.class);
      ...
      try (TFloat64 x1Tensor =
        ...
        session.evaluate(tf.constant(xmin), result, feedMap);
      }
    }
  }
}
