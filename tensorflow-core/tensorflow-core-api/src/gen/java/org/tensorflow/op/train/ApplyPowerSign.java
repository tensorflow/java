...
public final class ApplyPowerSign<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> ApplyPowerSign<T> create(Scope scope, Operand<T> var, Operand<T> m, Operand<T> lr, Operand<T> logbase, Operand<T> signDecay, Operand<T> beta, Operand<T> grad, Options... options) {
