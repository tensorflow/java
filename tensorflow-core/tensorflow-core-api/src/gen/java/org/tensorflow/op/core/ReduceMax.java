...
@OpMetadata(
    ...
    inputsClass = ReduceMax.Inputs.class
)
@Operator
public final class ReduceMax<T extends TNumber> extends RawOp implements Operand<T> {
  /**
  ...
  public ReduceMax(Operation operation) {
  ...
  public static <T extends TNumber> ReduceMax<T> create(Scope scope, Operand<T> input,
    ...
    return new ReduceMax<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = ReduceMax.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<ReduceMax<T>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new ReduceMax<>(op), op, Arrays.asList("keep_dims", "T", "Tidx"));
      int inputIndex = 0;
