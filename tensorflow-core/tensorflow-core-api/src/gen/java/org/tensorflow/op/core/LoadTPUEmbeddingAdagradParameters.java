 ...
 * executed.
 */
public final class LoadTPUEmbeddingAdagradParameters extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.LoadTPUEmbeddingAdagradParameters}
   */
   ...
   */
  public static LoadTPUEmbeddingAdagradParameters create(Scope scope, Operand<TFloat> parameters, Operand<TFloat> accumulators, Long numShards, Long shardId, Options... options) {
