...
public class Multiply<T extends TFloating> extends Merge<T> {
   ...
   */
  public Multiply(Ops tf, Class<T> type) {
    this(tf, null, type);
  }
   ...
   */
  public Multiply(Ops tf, Class<T> type, Options options) {
   ...
   * @param type the data type for the weights and computation
   */
  public Multiply(Ops tf, String name, Class<T> type) {
   ...
   * @param options the layer's options.
   */
  public Multiply(Ops tf, String name, Class<T> type, Options options) {
