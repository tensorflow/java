 ...
 */
public final class ParseExampleDatasetV2 extends RawOp implements Operand<TType> {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.ParseExampleDatasetV2}
   */
   ...
   * @return a new instance of ParseExampleDatasetV2
   */
  @Endpoint(describeByClass = true)
  public static ParseExampleDatasetV2 create(Scope scope, Operand<?> inputDataset, Operand<TInt64> numParallelCalls, Iterable<Operand<?>> denseDefaults, List<String> sparseKeys, List<String> denseKeys, List<DataType<?>> sparseTypes, List<Shape> denseShapes, List<DataType<?>> outputTypes, List<Shape> outputShapes, List<DataType<?>> raggedValueTypes, List<DataType<?>> raggedSplitTypes, Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder("ParseExampleDatasetV2", scope.makeOpName("ParseExampleDatasetV2"));
    ...
    return new ParseExampleDatasetV2(opBuilder.build());
  }
  ...
  private ParseExampleDatasetV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
