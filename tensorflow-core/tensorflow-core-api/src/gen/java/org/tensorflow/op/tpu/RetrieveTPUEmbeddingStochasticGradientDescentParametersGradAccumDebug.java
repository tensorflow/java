 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug extends RawOp {
  ...
  public RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug(
      Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
