 ...
 */
@Operator
public final class OnesLike<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> OnesLike<T> create(Scope scope, Operand<T> x) {
