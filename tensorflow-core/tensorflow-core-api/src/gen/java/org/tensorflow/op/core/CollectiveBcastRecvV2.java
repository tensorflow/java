...
public final class CollectiveBcastRecvV2<U extends TType> extends RawOp implements Operand<U> {
  ...
  public static <U extends TType> CollectiveBcastRecvV2<U> create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.env().opBuilder("CollectiveBcastRecvV2", scope.makeOpName("CollectiveBcastRecvV2"));
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.CollectiveBcastRecvV2}
   */
