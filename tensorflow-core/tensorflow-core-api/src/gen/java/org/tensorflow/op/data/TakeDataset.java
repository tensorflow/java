 ...
 */
@OpMetadata(
    opType = TakeDataset.OP_NAME,
    inputsClass = TakeDataset.Inputs.class
)
@Operator(
    group = "data"
)
public final class TakeDataset extends RawOp implements Operand<TType> {
  ...
  public TakeDataset(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = TakeDataset.class
  )
  public static class Inputs extends RawOpInputs<TakeDataset> {
    /**
