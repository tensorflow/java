 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingADAMParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingADAMParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingADAMParametersGradAccumDebug extends RawOp {
  ...
  public RetrieveTPUEmbeddingADAMParametersGradAccumDebug(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingADAMParametersGradAccumDebug create(Scope scope, Long numShards,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingADAMParametersGradAccumDebug");
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingADAMParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingADAMParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingADAMParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
