 ...
 */
public final class PrivateThreadPoolDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static PrivateThreadPoolDataset create(Scope scope, Operand<?> inputDataset, Operand<Long> numThreads, List<Class<?>> outputTypes, List<Shape> outputShapes) {
