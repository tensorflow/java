...
public final class QuantizationOps {
  ...
  public <U extends TType, T extends TType> Requantize<U> requantize(Operand<T> input,
      Operand<TFloat> inputMin, Operand<TFloat> inputMax, Operand<TFloat> requestedOutputMin,
  ...
  public <T extends TType> RequantizationRange requantizationRange(Operand<T> input,
      Operand<TFloat> inputMin, Operand<TFloat> inputMax) {
   ...
   */
  public <T extends TType> Dequantize dequantize(Operand<T> input, Operand<TFloat> minRange,
   ...
   */
  public <T extends TType> Quantize<T> quantize(Operand<TFloat> input, Operand<TFloat> minRange,
  ...
  public <U extends TType, T extends TType> QuantizeDownAndShrinkRange<U> quantizeDownAndShrinkRange(
      Operand<T> input, Operand<TFloat> inputMin, Operand<TFloat> inputMax, DataType<U> outType) {
