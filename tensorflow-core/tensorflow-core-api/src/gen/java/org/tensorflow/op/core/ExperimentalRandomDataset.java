 ...
 */
public final class ExperimentalRandomDataset extends PrimitiveOp implements Operand<Object> {
  ...
  public static ExperimentalRandomDataset create(Scope scope, Operand<TInt64> seed, Operand<TInt64> seed2, List<DataType<?>> outputTypes, List<Shape> outputShapes) {
    ...
    return new ExperimentalRandomDataset(opBuilder.build());
  }
  ...
  private ExperimentalRandomDataset(Operation operation) {
    super(operation);
    int outputIdx = 0;
