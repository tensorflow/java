 ...
 */
@Operator
public final class VarHandleOp extends RawOp implements Operand<Tensor> {
  ...
  public static <T extends Tensor> VarHandleOp create(Scope scope, DataType<T> dtype, Shape shape, Options... options) {
