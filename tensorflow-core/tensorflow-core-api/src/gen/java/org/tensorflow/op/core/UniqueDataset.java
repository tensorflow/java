 ...
 */
public final class UniqueDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static UniqueDataset create(Scope scope, Operand<?> inputDataset, List<Class<?>> outputTypes, List<Shape> outputShapes) {
