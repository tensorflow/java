 ...
 */
@Operator(group = "math")
public final class QuantizedMul<V extends Tensor> extends RawOp {
  ...
  public static <V extends Tensor, T extends Tensor, U extends Tensor> QuantizedMul<V> create(Scope scope, Operand<T> x, Operand<U> y, Operand<TFloat32> minX, Operand<TFloat32> maxX, Operand<TFloat32> minY, Operand<TFloat32> maxY, DataType<V> Toutput) {
