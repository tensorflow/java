 ...
 */
@Operator(group = "math")
public final class FloorDiv<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> FloorDiv<T> create(Scope scope, Operand<T> x, Operand<T> y) {
