...
public class Maximum<T extends TFloating> extends Merge<T> {
   ...
   */
  public Maximum(Class<T> type, Options options) {
   ...
   * @param type the data type for the weights and computation
   */
  public Maximum(String name, Class<T> type) {
    this(name, type, null);
  }
   ...
   * @param options the layer's options.
   */
  public Maximum(String name, Class<T> type, Options options) {
