 ...
 */
public final class MaxIntraOpParallelismDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static MaxIntraOpParallelismDataset create(Scope scope, Operand<?> inputDataset, Operand<Long> maxIntraOpParallelism, List<Class<?>> outputTypes, List<Shape> outputShapes) {
