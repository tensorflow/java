 ...
 */
@Operator(group = "math")
public final class Xdivy<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Xdivy<T> create(Scope scope, Operand<T> x, Operand<T> y) {
