 ...
 */
public final class InvGrad<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> InvGrad<T> create(Scope scope, Operand<T> y, Operand<T> dy) {
