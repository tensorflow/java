 ...
 */
@Operator
public final class Assign<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Assign<T> create(Scope scope, Operand<T> ref, Operand<T> value, Options... options) {
