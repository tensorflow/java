 ...
 */
@Operator
public final class GetSessionTensor<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> GetSessionTensor<T> create(Scope scope, Operand<TString> handle, DataType<T> dtype) {
