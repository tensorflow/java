...
class MaximumTest {
  ...
  double[][][] xmax = {
    {
      {0.82828211, 0.55677077, 0.7159566, 0.93377237, 0.61086578},
      {0.73234341, 0.39331301, 0.68069423, 0.96272026, 0.86098578},
      {0.99338463, 0.64175689, 0.74858191, 0.80589999, 0.94056888},
      {0.79376476, 0.24171677, 0.73475366, 0.9313434, 0.48606332}
    },
    {
      {0.56599224, 0.39567908, 0.89910993, 0.72514044, 0.73722061},
      {0.6212917, 0.62624375, 0.8184835, 0.44414272, 0.96730508},
      {0.89191749, 0.73008498, 0.9177326, 0.90297727, 0.82857399},
      {0.70014157, 0.95498672, 0.6179583, 0.79244879, 0.63492784}
    }
  };
  ...
  public void testAverage() {
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      Operand<TFloat64> input2 =
          Input.input(tf, TFloat64.class, Layer.Options.create().inputShape(Shape.of(4, 5)));
      Maximum<TFloat64> instance = new Maximum<>(TFloat64.class);
      ...
      try (TFloat64 x1Tensor =
        ...
        session.evaluate(tf.constant(xmax), result, feedMap);
      }
    }
  }
}
