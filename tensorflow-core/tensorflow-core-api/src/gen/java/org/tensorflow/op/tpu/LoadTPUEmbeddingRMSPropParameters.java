...
public final class LoadTPUEmbeddingRMSPropParameters extends PrimitiveOp {
   ...
   */
  public static LoadTPUEmbeddingRMSPropParameters create(Scope scope, Operand<TFloat> parameters, Operand<TFloat> ms, Operand<TFloat> mom, Long numShards, Long shardId, Options... options) {
