 ...
 */
@OpMetadata(
    opType = AllCandidateSampler.OP_NAME,
    inputsClass = AllCandidateSampler.Inputs.class
)
@Operator(
    group = "random"
)
public final class AllCandidateSampler extends RawOp {
  /**
  ...
  public static AllCandidateSampler create(Scope scope, Operand<TInt64> trueClasses, Long numTrue,
      Long numSampled, Boolean unique, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "AllCandidateSampler");
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.random.AllCandidateSampler}
   */
  ...
  @OpInputsMetadata(
      outputsClass = AllCandidateSampler.class
  )
