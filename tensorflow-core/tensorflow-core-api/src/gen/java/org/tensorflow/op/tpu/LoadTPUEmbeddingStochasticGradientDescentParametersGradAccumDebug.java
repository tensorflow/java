 ...
 */
@OpMetadata(
    opType = LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug.OP_NAME,
    inputsClass = LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug.Inputs.class
)
public final class LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug";

  public LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug(Operation operation) {
   ...
   * @param gradientAccumulators Value of gradient_accumulators used in the Adadelta optimization algorithm.
   * @param numShards The value of the numShards attribute
   * @param shardId The value of the shardId attribute
   * @param options carries optional attribute values
   * @return a new instance of LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug
   */
  @Endpoint(
      describeByClass = true
  )
  public static LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug create(
      Scope scope, Operand<TFloat32> parameters, Operand<TFloat32> gradientAccumulators,
      Long numShards, Long shardId, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug");
    ...
    return new LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug}
   */
  ...
  @OpInputsMetadata(
      outputsClass = LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new LoadTPUEmbeddingStochasticGradientDescentParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
