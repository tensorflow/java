...
//
//
//            List<Operand<?>> tensors = Arrays.asList(tf.constant(X), tf.constant(y));
//
...
//                );
//
//                DatasetIterator anonymousIter = DatasetIterator.create(tf.scope(), null, null, outputTypes, Arrays.asList(
//                        Shape.of(BATCH_SIZE, 3),
//                        Shape.of(BATCH_SIZE, 1)));
//
