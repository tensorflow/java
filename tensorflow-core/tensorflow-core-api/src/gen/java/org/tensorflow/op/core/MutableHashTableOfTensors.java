 ...
 */
@Operator
public final class MutableHashTableOfTensors extends RawOp implements Operand<Tensor> {
  ...
  public static <T extends Tensor, U extends Tensor> MutableHashTableOfTensors create(Scope scope, DataType<T> keyDtype, DataType<U> valueDtype, Options... options) {
