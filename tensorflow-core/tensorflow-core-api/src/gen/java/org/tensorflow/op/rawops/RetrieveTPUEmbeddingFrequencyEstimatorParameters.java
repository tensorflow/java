...
public final class RetrieveTPUEmbeddingFrequencyEstimatorParameters extends RawOp {
   ...
   */
  public static final String OP_NAME = "RetrieveTPUEmbeddingFrequencyEstimatorParameters";
  ...
  public static RetrieveTPUEmbeddingFrequencyEstimatorParameters create(Scope scope, Long numShards,
    ...
    OperationBuilder opBuilder = scope.env().opBuilder("RetrieveTPUEmbeddingFrequencyEstimatorParameters", scope.makeOpName("RetrieveTPUEmbeddingFrequencyEstimatorParameters"));
    ...
    return new RetrieveTPUEmbeddingFrequencyEstimatorParameters(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.rawops.RetrieveTPUEmbeddingFrequencyEstimatorParameters}
   */
