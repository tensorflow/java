 ...
 */
@OpMetadata(
    opType = QuantizedConv2DAndRelu.OP_NAME,
    inputsClass = QuantizedConv2DAndRelu.Inputs.class
)
public final class QuantizedConv2DAndRelu<V extends TNumber> extends RawOp {
  ...
  public QuantizedConv2DAndRelu(Operation operation) {
  ...
  public static <V extends TNumber> QuantizedConv2DAndRelu<V> create(Scope scope,
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedConv2DAndRelu");
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedConv2DAndRelu.class
  )
  public static class Inputs extends RawOpInputs<QuantizedConv2DAndRelu<?>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedConv2DAndRelu<>(op), op, Arrays.asList("Tinput", "Tfilter", "out_type", "strides", "padding", "dilations", "padding_list"));
      int inputIndex = 0;
