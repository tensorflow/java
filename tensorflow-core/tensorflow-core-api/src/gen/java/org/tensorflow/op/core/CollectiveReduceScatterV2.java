 ...
 */
@OpMetadata(
    opType = CollectiveReduceScatterV2.OP_NAME,
    inputsClass = CollectiveReduceScatterV2.Inputs.class
)
public final class CollectiveReduceScatterV2<T extends TNumber> extends RawOp implements Operand<T> {
  /**
  ...
  public CollectiveReduceScatterV2(Operation operation) {
   ...
   * @return a new instance of CollectiveReduceScatterV2
   */
  @Endpoint(
      describeByClass = true
  )
  public static <T extends TNumber> CollectiveReduceScatterV2<T> create(Scope scope,
      Operand<T> input, Operand<TInt32> groupSize, Operand<TInt32> groupKey,
      Operand<TInt32> instanceKey, Iterable<Operand<? extends TType>> orderingToken, String mergeOp,
      String finalOp, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "CollectiveReduceScatterV2");
    ...
    return new CollectiveReduceScatterV2<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.CollectiveReduceScatterV2}
   */
  ...
  @OpInputsMetadata(
      outputsClass = CollectiveReduceScatterV2.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<CollectiveReduceScatterV2<T>> {
    /**
     * The input input
     */
