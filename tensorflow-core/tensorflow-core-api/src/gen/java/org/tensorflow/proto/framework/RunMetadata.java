          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                org.tensorflow.proto.framework.GraphDef m =
                    input.readMessage(
                        org.tensorflow.proto.framework.GraphDef.parser(),
                        extensionRegistry);
                if (partitionGraphsBuilder_ == null) {
                  ensurePartitionGraphsIsMutable();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              org.tensorflow.proto.framework.RunMetadata.FunctionGraphs m =
                  input.readMessage(
                      org.tensorflow.proto.framework.RunMetadata.FunctionGraphs.parser(),
                      extensionRegistry);
              if (functionGraphsBuilder_ == null) {
                ensureFunctionGraphsIsMutable();
