 ...
 */
@Operator
public final class MatrixDiagPartV2<T extends TType> extends PrimitiveOp implements Operand<T> {
   ...
   */
  public static <T extends TType> MatrixDiagPartV2<T> create(Scope scope, Operand<T> input, Operand<TInt32> k, Operand<T> paddingValue) {
    ...
    return new MatrixDiagPartV2<T>(opBuilder.build());
  }
  ...
  private MatrixDiagPartV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
