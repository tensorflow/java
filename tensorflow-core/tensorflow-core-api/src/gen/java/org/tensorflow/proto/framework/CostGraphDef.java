        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                org.tensorflow.proto.framework.CostGraphDef.Node.InputInfo m =
                    input.readMessage(
                        org.tensorflow.proto.framework.CostGraphDef.Node.InputInfo.parser(),
                        extensionRegistry);
                if (inputInfoBuilder_ == null) {
                  ensureInputInfoIsMutable();
                  inputInfo_.add(m);
              ...
              case 42: {
                org.tensorflow.proto.framework.CostGraphDef.Node.OutputInfo m =
                    input.readMessage(
                        org.tensorflow.proto.framework.CostGraphDef.Node.OutputInfo.parser(),
                        extensionRegistry);
                if (outputInfoBuilder_ == null) {
                  ensureOutputInfoIsMutable();
                  outputInfo_.add(m);
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.proto.framework.CostGraphDef.Node m =
                  input.readMessage(
                      org.tensorflow.proto.framework.CostGraphDef.Node.parser(),
                      extensionRegistry);
              if (nodeBuilder_ == null) {
                ensureNodeIsMutable();
                node_.add(m);
            ...
            case 18: {
              org.tensorflow.proto.framework.CostGraphDef.AggregatedCost m =
                  input.readMessage(
                      org.tensorflow.proto.framework.CostGraphDef.AggregatedCost.parser(),
                      extensionRegistry);
              if (costBuilder_ == null) {
                ensureCostIsMutable();
                cost_.add(m);
