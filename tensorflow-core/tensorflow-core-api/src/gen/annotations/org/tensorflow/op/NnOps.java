...
public final class NnOps {
   ...
   */
  public <U extends Number, T extends Number> CudnnRnnParamsSize<U> cudnnRnnParamsSize(
      Operand<Integer> numLayers, Operand<Integer> numUnits, Operand<Integer> inputSize, Class<T> T,
   ...
   */
  public <T extends Number> SoftmaxCrossEntropyWithLogits<T> softmaxCrossEntropyWithLogits(
   ...
   */
  public <T extends Number, U extends Number> SparseSoftmaxCrossEntropyWithLogits<T> sparseSoftmaxCrossEntropyWithLogits(
   ...
   */
  public <T extends Number> DepthwiseConv2dNativeBackpropInput<T> depthwiseConv2dNativeBackpropInput(
      Operand<Integer> inputSizes, Operand<T> filter, Operand<T> outBackprop, List<Long> strides,
   ...
   */
  public <T extends Number, U extends Number> FusedBatchNormGrad<T, U> fusedBatchNormGrad(
      Operand<T> yBackprop, Operand<T> x, Operand<Float> scale, Operand<U> reserveSpace1,
   ...
   */
  public <T> MaxPool<T> maxPool(Operand<T> input, Operand<Integer> ksize, Operand<Integer> strides,
   ...
   */
  public <T extends Number> CudnnRnnCanonicalToParams<T> cudnnRnnCanonicalToParams(
      Operand<Integer> numLayers, Operand<Integer> numUnits, Operand<Integer> inputSize,
   ...
   */
  public <T extends Number> InTopK inTopK(Operand<Float> predictions, Operand<T> targets,
      Operand<T> k) {
   ...
   */
  public <T extends Number, U extends Number> MaxPoolWithArgmax<T, U> maxPoolWithArgmax(
   ...
   */
  public <T extends Number, U extends Number> FusedBatchNorm<T, U> fusedBatchNorm(Operand<T> x,
   ...
   */
  public <T extends Number> CudnnRnnParamsToCanonical<T> cudnnRnnParamsToCanonical(
      Operand<Integer> numLayers, Operand<Integer> numUnits, Operand<Integer> inputSize,
   ...
   */
  public <T extends Number, U extends Number> MaxPoolGradGradWithArgmax<T> maxPoolGradGradWithArgmax(
   ...
   */
  public <U extends Number, T extends Number> Conv3dBackpropInput<U> conv3dBackpropInput(
   ...
   */
  public <T extends Number> LocalResponseNormalization<T> localResponseNormalization(
   ...
   */
  public <T extends Number> DepthwiseConv2dNativeBackpropFilter<T> depthwiseConv2dNativeBackpropFilter(
      Operand<T> input, Operand<Integer> filterSizes, Operand<T> outBackprop, List<Long> strides,
   ...
   */
  public <T extends Number> MaxPoolGrad<T> maxPoolGrad(Operand<T> origInput, Operand<T> origOutput,
      Operand<T> grad, Operand<Integer> ksize, Operand<Integer> strides, String padding,
  ...
  public <U, T> QuantizedBatchNormWithGlobalNormalization<U> quantizedBatchNormWithGlobalNormalization(
      Operand<T> t, Operand<Float> tMin, Operand<Float> tMax, Operand<T> m, Operand<Float> mMin,
