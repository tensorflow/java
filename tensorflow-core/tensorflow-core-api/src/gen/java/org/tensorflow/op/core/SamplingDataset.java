...
public final class SamplingDataset extends PrimitiveOp implements Operand<Object> {
   ...
   * @param inputDataset 
   * @param rate A scalar representing the sample rate of elements from the `input_dataset`
   ...
   */
  public static SamplingDataset create(Scope scope, Operand<?> inputDataset, Operand<TFloat> rate, Operand<TInt64> seed, Operand<TInt64> seed2, List<DataType<?>> outputTypes, List<Shape> outputShapes) {
