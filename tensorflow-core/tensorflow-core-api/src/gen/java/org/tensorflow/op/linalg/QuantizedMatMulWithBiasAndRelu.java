 ...
 */
public final class QuantizedMatMulWithBiasAndRelu<V extends Tensor> extends RawOp {
  ...
  public static <V extends Tensor, T extends Tensor, U extends Tensor> QuantizedMatMulWithBiasAndRelu<V> create(Scope scope, Operand<T> a, Operand<U> b, Operand<TFloat32> bias, Operand<TFloat32> minA, Operand<TFloat32> maxA, Operand<TFloat32> minB, Operand<TFloat32> maxB, DataType<V> Toutput, Options... options) {
