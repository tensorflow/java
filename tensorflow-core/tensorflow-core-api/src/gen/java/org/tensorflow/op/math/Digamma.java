 ...
 */
@Operator(group = "math")
public final class Digamma<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> Digamma<T> create(Scope scope, Operand<T> x) {
