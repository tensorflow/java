 ...
 */
public final class SlidingWindowDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static SlidingWindowDataset create(Scope scope, Operand<?> inputDataset, Operand<Long> windowSize, Operand<Long> windowShift, Operand<Long> windowStride, List<Class<?>> outputTypes, List<Shape> outputShapes) {
