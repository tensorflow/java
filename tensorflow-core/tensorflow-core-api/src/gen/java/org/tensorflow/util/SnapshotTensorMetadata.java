...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              tensorMetadata_ = new java.util.ArrayList<org.tensorflow.util.TensorMetadata>();
              mutable_bitField0_ |= 0x00000001;
            }
            tensorMetadata_.add(
                input.readMessage(org.tensorflow.util.TensorMetadata.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return org.tensorflow.util.SnapshotProtos.internal_static_tensorflow_data_experimental_SnapshotTensorMetadata_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return org.tensorflow.util.SnapshotProtos.internal_static_tensorflow_data_experimental_SnapshotTensorMetadata_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            org.tensorflow.util.SnapshotTensorMetadata.class, org.tensorflow.util.SnapshotTensorMetadata.Builder.class);
  }

  public static final int TENSOR_METADATA_FIELD_NUMBER = 1;
  private java.util.List<org.tensorflow.util.TensorMetadata> tensorMetadata_;
  /**
   * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
   */
  public java.util.List<org.tensorflow.util.TensorMetadata> getTensorMetadataList() {
    return tensorMetadata_;
  }
  /**
   * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
   */
  public java.util.List<? extends org.tensorflow.util.TensorMetadataOrBuilder> 
   ...
   * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
   */
  public org.tensorflow.util.TensorMetadata getTensorMetadata(int index) {
    return tensorMetadata_.get(index);
  }
  /**
   * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
   */
  public org.tensorflow.util.TensorMetadataOrBuilder getTensorMetadataOrBuilder(
      int index) {
    return tensorMetadata_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof org.tensorflow.util.SnapshotTensorMetadata)) {
      return super.equals(obj);
    }
    org.tensorflow.util.SnapshotTensorMetadata other = (org.tensorflow.util.SnapshotTensorMetadata) obj;
  ...
  public static org.tensorflow.util.SnapshotTensorMetadata parseFrom(
  ...
  public static org.tensorflow.util.SnapshotTensorMetadata parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static org.tensorflow.util.SnapshotTensorMetadata parseFrom(
  ...
  public static org.tensorflow.util.SnapshotTensorMetadata parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static org.tensorflow.util.SnapshotTensorMetadata parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static org.tensorflow.util.SnapshotTensorMetadata parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(org.tensorflow.util.SnapshotTensorMetadata prototype) {
  ...
  public static final class Builder extends
      ...
      org.tensorflow.util.SnapshotTensorMetadataOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return org.tensorflow.util.SnapshotProtos.internal_static_tensorflow_data_experimental_SnapshotTensorMetadata_descriptor;
    }
    ...
    // Construct using org.tensorflow.util.SnapshotTensorMetadata.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public org.tensorflow.util.SnapshotTensorMetadata getDefaultInstanceForType() {
      return org.tensorflow.util.SnapshotTensorMetadata.getDefaultInstance();
    }

    @java.lang.Override
    public org.tensorflow.util.SnapshotTensorMetadata build() {
      org.tensorflow.util.SnapshotTensorMetadata result = buildPartial();
    ...
    @java.lang.Override
    public org.tensorflow.util.SnapshotTensorMetadata buildPartial() {
      org.tensorflow.util.SnapshotTensorMetadata result = new org.tensorflow.util.SnapshotTensorMetadata(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof org.tensorflow.util.SnapshotTensorMetadata) {
        return mergeFrom((org.tensorflow.util.SnapshotTensorMetadata)other);
      } else {
    ...
    public Builder mergeFrom(org.tensorflow.util.SnapshotTensorMetadata other) {
      if (other == org.tensorflow.util.SnapshotTensorMetadata.getDefaultInstance()) return this;
      if (tensorMetadataBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.tensorflow.util.SnapshotTensorMetadata parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.tensorflow.util.SnapshotTensorMetadata) e.getUnfinishedMessage();
    ...
    private void ensureTensorMetadataIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        tensorMetadata_ = new java.util.ArrayList<org.tensorflow.util.TensorMetadata>(tensorMetadata_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        org.tensorflow.util.TensorMetadata, org.tensorflow.util.TensorMetadata.Builder, org.tensorflow.util.TensorMetadataOrBuilder> tensorMetadataBuilder_;
    ...
    public Builder setTensorMetadata(
        int index, org.tensorflow.util.TensorMetadata value) {
      if (tensorMetadataBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setTensorMetadata(
        int index, org.tensorflow.util.TensorMetadata.Builder builderForValue) {
      if (tensorMetadataBuilder_ == null) {
        ensureTensorMetadataIsMutable();
     ...
     * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
     */
    public Builder addTensorMetadata(org.tensorflow.util.TensorMetadata value) {
      if (tensorMetadataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addTensorMetadata(
        org.tensorflow.util.TensorMetadata.Builder builderForValue) {
      if (tensorMetadataBuilder_ == null) {
        ensureTensorMetadataIsMutable();
    ...
    public Builder addAllTensorMetadata(
        java.lang.Iterable<? extends org.tensorflow.util.TensorMetadata> values) {
      if (tensorMetadataBuilder_ == null) {
        ensureTensorMetadataIsMutable();
     ...
     * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
     */
    public org.tensorflow.util.TensorMetadata.Builder getTensorMetadataBuilder(
        int index) {
     ...
     * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
     */
    public org.tensorflow.util.TensorMetadata.Builder addTensorMetadataBuilder() {
      return getTensorMetadataFieldBuilder().addBuilder(
          org.tensorflow.util.TensorMetadata.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
     */
    public org.tensorflow.util.TensorMetadata.Builder addTensorMetadataBuilder(
        int index) {
      return getTensorMetadataFieldBuilder().addBuilder(
          index, org.tensorflow.util.TensorMetadata.getDefaultInstance());
    }
    /**
     * <code>repeated .tensorflow.data.experimental.TensorMetadata tensor_metadata = 1;</code>
     */
    public java.util.List<org.tensorflow.util.TensorMetadata.Builder> 
         getTensorMetadataBuilderList() {
      return getTensorMetadataFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        org.tensorflow.util.TensorMetadata, org.tensorflow.util.TensorMetadata.Builder, org.tensorflow.util.TensorMetadataOrBuilder> 
        getTensorMetadataFieldBuilder() {
      if (tensorMetadataBuilder_ == null) {
  ...
  private static final org.tensorflow.util.SnapshotTensorMetadata DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new org.tensorflow.util.SnapshotTensorMetadata();
  }

  public static org.tensorflow.util.SnapshotTensorMetadata getDefaultInstance() {
