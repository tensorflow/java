 ...
 */
@Operator(group = "math")
public final class Reciprocal<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Reciprocal<T> create(Scope scope, Operand<T> x) {
