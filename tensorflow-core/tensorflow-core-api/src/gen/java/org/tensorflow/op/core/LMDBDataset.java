...
/**
 */
public final class LMDBDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static LMDBDataset create(Scope scope, Operand<String> filenames, List<Class<?>> outputTypes, List<Shape> outputShapes) {
