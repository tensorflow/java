...
public final class TruncatedNormal<U extends TNumber> extends RawOp implements Operand<U> {
  /**
  ...
  public static <U extends TNumber> TruncatedNormal<U> create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "TruncatedNormal");
    ...
    return new TruncatedNormal<>(opBuilder.build());
  }
  ...
  public static class Inputs extends RawOpInputs<TruncatedNormal<?>> {
    ...
    public Inputs(GraphOperation op) {
      super(new TruncatedNormal<>(op), op, Arrays.asList("seed", "seed2", "dtype", "T"));
      int inputIndex = 0;
