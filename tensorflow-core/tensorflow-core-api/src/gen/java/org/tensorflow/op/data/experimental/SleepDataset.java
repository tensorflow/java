...
public final class SleepDataset extends RawOp implements Operand<TType> {
  ...
  public static class Inputs extends RawOpInputs<SleepDataset> {
     ...
     */
    public final Operand<TInt64> sleepMicroseconds;
    ...
    public Inputs(GraphOperation op) {
      super(new SleepDataset(op), op, Arrays.asList("output_types", "output_shapes"));
      int inputIndex = 0;
      inputDataset = (Operand<? extends TType>) op.input(inputIndex++);
      sleepMicroseconds = (Operand<TInt64>) op.input(inputIndex++);
