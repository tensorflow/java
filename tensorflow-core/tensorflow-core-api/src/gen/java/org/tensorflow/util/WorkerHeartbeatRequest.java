    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            org.tensorflow.util.RequestedExitCode.Builder subBuilder = null;
            if (exitCode_ != null) {
              subBuilder = exitCode_.toBuilder();
            }
            exitCode_ = input.readMessage(org.tensorflow.util.RequestedExitCode.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeExitCode(org.tensorflow.util.RequestedExitCode value) {
      if (exitCodeBuilder_ == null) {
        if (exitCode_ != null) {
          exitCode_ =
            org.tensorflow.util.RequestedExitCode.newBuilder(exitCode_).mergeFrom(value).buildPartial();
        } else {
          exitCode_ = value;
        }
        onChanged();
