...
@OpMetadata(
    ...
    inputsClass = Sigmoid.Inputs.class
)
@Operator(
    group = "math"
)
public final class Sigmoid<T extends TType> extends RawOp implements Operand<T> {
  ...
  @OpInputsMetadata(
      outputsClass = Sigmoid.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<Sigmoid<T>> {
    /**
     * The x input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Sigmoid<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
