 ...
 * </pre>
 */
public final class AssignVariableXlaConcatND extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "AssignVariableXlaConcatND";

  private AssignVariableXlaConcatND(Operation operation) {
    super(operation);
  }
   ...
   * @return a new instance of AssignVariableXlaConcatND
   */
  @Endpoint(
      describeByClass = true
  )
  public static AssignVariableXlaConcatND create(Scope scope, Operand<? extends TType> resource,
      Iterable<Operand<? extends TType>> inputs, List<Long> numConcats, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "AssignVariableXlaConcatND");
    ...
    return new AssignVariableXlaConcatND(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.rawops.AssignVariableXlaConcatND}
   */
  ...
  public static class Inputs extends RawOpInputs<AssignVariableXlaConcatND> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new AssignVariableXlaConcatND(op), op, Arrays.asList("T", "num_concats", "paddings"));
      int inputIndex = 0;
