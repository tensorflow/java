...
public final class ResourceSparseApplyAdagrad extends RawOp {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber> ResourceSparseApplyAdagrad create(Scope scope, Operand<?> var, Operand<?> accum, Operand<T> lr, Operand<T> grad, Operand<U> indices, Options... options) {
