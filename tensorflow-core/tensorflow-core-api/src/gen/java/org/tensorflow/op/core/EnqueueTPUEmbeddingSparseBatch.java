 ...
 */
public final class EnqueueTPUEmbeddingSparseBatch extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.EnqueueTPUEmbeddingSparseBatch}
   */
