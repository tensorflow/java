...
public final class DrawBoundingBoxes<T extends TNumber> extends PrimitiveOp implements Operand<T> {
   ...
   */
  public static <T extends TNumber> DrawBoundingBoxes<T> create(Scope scope, Operand<T> images, Operand<TFloat32> boxes) {
