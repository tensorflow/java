...
public class Dot<T extends TFloating> extends Merge<T> {
   ...
   */
  public Dot(int axes, Class<T> type) {
    this(null, new int[] {axes}, false, type, null);
  }
   ...
   */
  public Dot(int axes, Class<T> type, Options options) {
    this(null, new int[] {axes}, false, type, options);
  }
   ...
   */
  public Dot(int[] axes, Class<T> type) {
    this(null, axes, false, type, null);
  }
   ...
   */
  public Dot(int[] axes, Class<T> type, Options options) {
    this(null, axes, false, type, options);
  }
   ...
   * @param type the data type for the weights and computation
   */
  public Dot(String name, int axes, Class<T> type) {
    this(name, new int[] {axes}, false, type, null);
  }
   ...
   * @param options the layer's options
   */
  public Dot(String name, int axes, Class<T> type, Options options) {
    this(name, new int[] {axes}, false, type, options);
  }
   ...
   */
  public Dot(String name, int[] axes, Class<T> type) {
    this(name, axes, false, type, null);
  }
   ...
   */
  public Dot(String name, int[] axes, Class<T> type, Options options) {
    this(name, axes, false, type, options);
  }
   ...
   * @param type the data type for the weights and computation
   */
  public Dot(String name, int axes, boolean normalize, Class<T> type) {
    this(name, new int[] {axes}, normalize, type, null);
  }
   ...
   * @param options the layer's options
   */
  public Dot(String name, int axes, boolean normalize, Class<T> type, Options options) {
    this(name, new int[] {axes}, normalize, type, options);
  }
   ...
   */
  public Dot(String name, int[] axes, boolean normalize, Class<T> type) {
    this(name, axes, normalize, type, null);
  }
