...
public interface QueueRunnerDefOrBuilder extends
   ...
   */
  java.util.List<org.tensorflow.proto.framework.Code> getQueueClosedExceptionTypesList();
  /**
   * <pre>
   * A list of exception types considered to signal a safely closed queue
   * if raised during enqueue operations.
   ...
   * <code>repeated .tensorflow.error.Code queue_closed_exception_types = 5;</code>
   */
  org.tensorflow.proto.framework.Code getQueueClosedExceptionTypes(int index);
  /**
   * <pre>
   * A list of exception types considered to signal a safely closed queue
   * if raised during enqueue operations.
