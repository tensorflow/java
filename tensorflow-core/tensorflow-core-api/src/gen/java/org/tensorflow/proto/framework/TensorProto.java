      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114: {
              org.tensorflow.proto.framework.ResourceHandleProto m =
                  input.readMessage(
                      org.tensorflow.proto.framework.ResourceHandleProto.parser(),
                      extensionRegistry);
              if (resourceHandleValBuilder_ == null) {
                ensureResourceHandleValIsMutable();
            ...
            case 122: {
              org.tensorflow.proto.framework.VariantTensorDataProto m =
                  input.readMessage(
                      org.tensorflow.proto.framework.VariantTensorDataProto.parser(),
                      extensionRegistry);
              if (variantValBuilder_ == null) {
                ensureVariantValIsMutable();
                variantVal_.add(m);
