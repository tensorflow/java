...
public final class BatchMatrixDiag<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> BatchMatrixDiag<T> create(Scope scope, Operand<T> diagonal) {
