 ...
 *
 * <p>If {@code sampleWeights} is given, calculates the sum of the weights of false positives. This
...
public class FalsePositives<T extends TNumber> extends ConfusionMatrixConditionCount<T> {
   ...
   */
  public FalsePositives(long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalsePositives(float threshold, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalsePositives(float[] thresholds, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalsePositives(String name, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalsePositives(String name, float threshold, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalsePositives(String name, float[] thresholds, long seed, Class<T> type) {
    super(name, ConfusionMatrixEnum.FALSE_POSITIVES, thresholds, seed, type);
  }
}
