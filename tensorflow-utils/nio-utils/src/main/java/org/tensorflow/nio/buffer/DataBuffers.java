...
public final class DataBuffers {
  ...
  public static ByteDataBuffer ofBytes(long size) {
    return unsafeAvailable ? ByteRawDataBuffer.allocate(size) : ByteJdkDataBuffer.allocate(size);
  }
  ...
  public static LongDataBuffer ofLongs(long size) {
    return unsafeAvailable ? LongRawDataBuffer.allocate(size) : LongJdkDataBuffer.allocate(size);
  }
  ...
  public static IntDataBuffer ofInts(long size) {
    return unsafeAvailable ? IntRawDataBuffer.allocate(size) : IntJdkDataBuffer.allocate(size);
  }
  ...
  public static ShortDataBuffer ofShorts(long size) {
    return unsafeAvailable ? ShortRawDataBuffer.allocate(size) : ShortJdkDataBuffer.allocate(size);
  }
  ...
  public static DoubleDataBuffer ofDoubles(long size) {
    return unsafeAvailable ? DoubleRawDataBuffer.allocate(size) : DoubleJdkDataBuffer.allocate(size);
  }
  ...
  public static FloatDataBuffer ofFloats(long size) {
    return unsafeAvailable ? FloatRawDataBuffer.allocate(size) : FloatJdkDataBuffer.allocate(size);
  }
  ...
  public static BooleanDataBuffer ofBooleans(long size) {
    return unsafeAvailable ? BooleanRawDataBuffer.allocate(size) : BitSetDataBuffer.allocate(size);
  }
