 ...
 */
public final class QuantizedConv2DWithBiasAndReluAndRequantize<W extends Tensor> extends RawOp {
  ...
  public static <W extends Tensor, T extends Tensor, U extends Tensor, V extends Tensor> QuantizedConv2DWithBiasAndReluAndRequantize<W> create(Scope scope, Operand<T> input, Operand<U> filter, Operand<V> bias, Operand<TFloat32> minInput, Operand<TFloat32> maxInput, Operand<TFloat32> minFilter, Operand<TFloat32> maxFilter, Operand<TFloat32> minFreezedOutput, Operand<TFloat32> maxFreezedOutput, DataType<W> outType, List<Long> strides, String padding, Options... options) {
    ...
    return new QuantizedConv2DWithBiasAndReluAndRequantize<W>(opBuilder.build());
  }
