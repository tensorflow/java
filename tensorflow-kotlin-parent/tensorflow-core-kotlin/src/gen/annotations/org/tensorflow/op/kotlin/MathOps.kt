...
public class MathOps(
     ...
     *  <em>NOTE</em>: ``` math.Add``` supports broadcasting. ``` AddN``` does not. More about
     * broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *  Given two input tensors, the ``` tf.add``` operation computes the sum for every element in
     * the tensor.
     ...
     *  ``` input``` must be complex numbers of the form \(a + bj\), where <em>a</em>
     ...
     *  <strong>Note</strong>: The output of ``` tf.math.asin``` will lie within the invertible
     * range
     ...
     * float(&quot;inf&quot;)])
     *  tf.math.asinh(x) ==&gt; &#91;-inf -1.4436355 -0.4812118 0.8813736 1.0159732 5.991471
     * 9.903487 inf]
     *
     *
     * @param T data type for ` y` output
     ...
     *  <strong>Note</strong>: The output of ``` tf.math.atan``` will lie within the invertible
     * range
     ...
     *  ``` nan``` as output.
     *
     *  x = tf.constant(&#91;-float(&quot;inf&quot;), -1, -0.5, 1, 0, 0.5, 10,
     * float(&quot;inf&quot;)])
     ...
     *
     *  <strong>NOTE</strong>: Currently, the innermost dimension of the tensor must be divisible
     *  by 8.
     ...
     *  is ``` [1, inf]```.
     *
     *  x = tf.constant(&#91;-float(&quot;inf&quot;), -9, -0.5, 1, 1.2, 2, 10,
     * float(&quot;inf&quot;)])
    ...
    /**
     * Returns x / y element-wise.
     *  <em>NOTE</em>: ``` math.Div``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  <em>NOTE</em>: ``` math.DivNoNan``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  <em>NOTE</em>: ``` math.Equal``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     *  x = tf.constant(&#91;2, 4])
     *  y = tf.constant(2)
    ...
    /**
     * Returns x // y element-wise.
     *  <em>NOTE</em>: ``` math.FloorDiv``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  <em>NOTE</em>: ``` math.FloorMod``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
    ...
    /**
     * Returns the truth value of (x &gt; y) element-wise.
     *  <em>NOTE</em>: ``` math.Greater``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *  Example:
     *
     *  x = tf.constant(&#91;5, 4, 6])
    ...
    /**
     * Returns the truth value of (x &gt;= y) element-wise.
     *  <em>NOTE</em>: ``` math.GreaterEqual``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *  Example:
     *
     ...
     *  elements in ``` input``` must be complex numbers of the form \(a + bj\), where <em>a</em>
    ...
    /**
     * Returns the truth value of (x &lt; y) element-wise.
     *  <em>NOTE</em>: ``` math.Less``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *  Example:
     *
     *  x = tf.constant(&#91;5, 4, 6])
    ...
    /**
     * Returns the truth value of (x &lt;= y) element-wise.
     *  <em>NOTE</em>: ``` math.LessEqual``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *  Example:
     *
     *  x = tf.constant(&#91;5, 4, 6])
     ...
     *  <em>NOTE</em>: ``` math.LogicalAnd``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param x the x value
     * @param y the y value
     ...
     *  <em>NOTE</em>: ``` math.LogicalOr``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param x the x value
     * @param y the y value
     ...
     *  <em>NOTE</em>: ``` math.Maximum``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  <em>NOTE</em>: ``` math.Minimum``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  <em>NOTE</em>: ``` math.Mod``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
    ...
    /**
     * Returns x * y element-wise.
     *  <em>NOTE</em>: ``` math.Mul``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  <em>NOTE</em>: ``` math.MulNoNan``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
    ...
    /**
     * Returns the truth value of (x != y) element-wise.
     *  <em>NOTE</em>: ``` math.NotEqual``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param x the x value
     * @param y the y value
     ...
     *  <strong>NOTE</strong>: It is more efficient to first ``` tf.bitcast``` your tensors into
     ...
     *  ``` input``` must be complex numbers of the form \(a + bj\), where <em>a</em> is the real
     ...
     *  Read
     *   <a href="https://tensorflow.org/api_docs/python/tf/math#Segmentation">the section on
     * segmentation</a>
     ...
     *  <blockquote>
     *  tf.math.sign(&#91;0., 2., -3.])
     *  &lt;tf.Tensor: shape=(3,), dtype=float32, numpy=array(&#91; 0.,  1., -1.],
     * dtype=float32)&gt;
     *  </blockquote>
     *  </blockquote>
     *  </blockquote>
     ...
     *  <em>NOTE</em>: ``` math.SquaredDifference``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
    ...
    /**
     * Returns x - y element-wise.
     *  <em>NOTE</em>: ``` math.Sub``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     *  x = tf.constant(&#91;-float(&quot;inf&quot;), -9, -0.5, 1, 1.2, 200, 10000,
     * float(&quot;inf&quot;)])
     *  tf.math.tan(x) ==&gt; &#91;nan 0.45231566 -0.5463025 1.5574077 2.572152 -1.7925274
     * 0.32097113 nan]
     *
     *
     * @param T data type for ` y` output
     ...
     *  <blockquote>
     *  <blockquote>
     *  x = tf.constant(&#91;-float(&quot;inf&quot;), -5, -0.5, 1, 1.2, 2, 3,
     * float(&quot;inf&quot;)])
     *  tf.math.tanh(x)
     ...
     *  Python Semantics.
     *  <em>NOTE</em>: ``` math.TruncateDiv``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
     ...
     * truncate_mod(x, y) = x```.
     *  <em>NOTE</em>: ``` math.TruncateMod``` supports broadcasting. More about broadcasting
     *   <a href="http://docs.scipy.org/doc/numpy/user/basics.broadcasting.html">here</a>
     *
     * @param T data type for ` z` output
     * @param x the x value
    ...
    public inline fun <reified V : TNumber> argMaxTyped(
        input: Operand<out TType>,
        dimension: Operand<out TNumber>
    ): ArgMax<V> = argMax<V>(input, dimension, V::class.java)
    ...
    public inline fun <reified V : TNumber> argMinTyped(
        input: Operand<out TType>,
        dimension: Operand<out TNumber>
    ): ArgMin<V> = argMin<V>(input, dimension, V::class.java)
