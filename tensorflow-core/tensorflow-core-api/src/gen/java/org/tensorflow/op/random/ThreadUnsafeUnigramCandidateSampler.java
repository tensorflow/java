 ...
 */
@OpMetadata(
    opType = ThreadUnsafeUnigramCandidateSampler.OP_NAME,
    inputsClass = ThreadUnsafeUnigramCandidateSampler.Inputs.class
)
@Operator(
    group = "random"
)
public final class ThreadUnsafeUnigramCandidateSampler extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "ThreadUnsafeUnigramCandidateSampler";
  ...
  public ThreadUnsafeUnigramCandidateSampler(Operation operation) {
  ...
  public static ThreadUnsafeUnigramCandidateSampler create(Scope scope, Operand<TInt64> trueClasses,
      Long numTrue, Long numSampled, Boolean unique, Long rangeMax, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "ThreadUnsafeUnigramCandidateSampler");
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.random.ThreadUnsafeUnigramCandidateSampler}
   */
  ...
  @OpInputsMetadata(
      outputsClass = ThreadUnsafeUnigramCandidateSampler.class
  )
  public static class Inputs extends RawOpInputs<ThreadUnsafeUnigramCandidateSampler> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new ThreadUnsafeUnigramCandidateSampler(op), op, Arrays.asList("num_true", "num_sampled", "unique", "range_max", "seed", "seed2"));
      int inputIndex = 0;
