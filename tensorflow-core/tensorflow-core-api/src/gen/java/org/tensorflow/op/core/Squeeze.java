 ...
 */
@Operator
public final class Squeeze<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Squeeze<T> create(Scope scope, Operand<T> input, Options... options) {
