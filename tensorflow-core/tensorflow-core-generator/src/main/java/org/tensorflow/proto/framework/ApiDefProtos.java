...
public final class ApiDefProtos {
  ...
  static {
    String[] descriptorData = {
      ...
      "B\203\001\n\036org.tensorflow.proto.frameworkB\014Api" +
      "DefProtosP\001ZNgithub.com/tensorflow/tenso" +
      "rflow/tensorflow/go/core/framework/api_d" +
    ...
    internal_static_tensorflow_ApiDef_fieldAccessorTable = new
        com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_ApiDef_descriptor,
        new String[]{"GraphOpName", "DeprecationMessage", "DeprecationVersion", "Visibility", "Endpoint", "InArg",
            "OutArg", "ArgOrder", "Attr", "Summary", "Description", "DescriptionPrefix", "DescriptionSuffix",});
    internal_static_tensorflow_ApiDef_Endpoint_descriptor =
    ...
    internal_static_tensorflow_ApiDef_Endpoint_fieldAccessorTable = new
        com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_ApiDef_Endpoint_descriptor,
        new String[]{"Name", "Deprecated", "DeprecationVersion",});
    internal_static_tensorflow_ApiDef_Arg_descriptor =
