...
public final class Cholesky<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Cholesky<T> create(Scope scope, Operand<T> input) {
