 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingFTRLParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingFTRLParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingFTRLParametersGradAccumDebug extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "RetrieveTPUEmbeddingFTRLParametersGradAccumDebug";
  ...
  public RetrieveTPUEmbeddingFTRLParametersGradAccumDebug(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingFTRLParametersGradAccumDebug create(Scope scope, Long numShards,
    ...
    return new RetrieveTPUEmbeddingFTRLParametersGradAccumDebug(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.RetrieveTPUEmbeddingFTRLParametersGradAccumDebug}
   */
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingFTRLParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingFTRLParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingFTRLParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
