        ...
        switch (tag) {
          ...
          case 58: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              metrics_ = new java.util.ArrayList<org.tensorflow.util.testlog.MetricEntry>();
              mutable_bitField0_ |= 0x00000002;
            }
            metrics_.add(
                input.readMessage(org.tensorflow.util.testlog.MetricEntry.parser(), extensionRegistry));
            break;
          }
          default: {
