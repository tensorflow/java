...
public final class Gather<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber, V extends Tensor & TNumber> Gather<T> create(Scope scope, Operand<T> params, Operand<U> indices, Operand<V> axis, Options... options) {
