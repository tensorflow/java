...
/**
 */
public final class CacheDatasetV2 extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static CacheDatasetV2 create(Scope scope, Operand<?> inputDataset, Operand<String> filename, Operand<?> cache, List<Class<?>> outputTypes, List<Shape> outputShapes) {
