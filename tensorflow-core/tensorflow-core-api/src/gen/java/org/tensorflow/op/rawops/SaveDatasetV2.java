 ...
 */
public final class SaveDatasetV2 extends RawOp implements Operand<TType> {
  /**
  ...
  private SaveDatasetV2(Operation operation) {
    super(operation);
    int outputIdx = 0;
   ...
   * @return a new instance of SaveDatasetV2
   */
  @Endpoint(
      describeByClass = true
  )
  public static SaveDatasetV2 create(Scope scope, Operand<? extends TType> inputDataset,
      Operand<TString> path, Iterable<Operand<?>> shardFuncOtherArgs, ConcreteFunction shardFunc,
      List<Class<? extends TType>> outputTypes, List<Shape> outputShapes, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "SaveDatasetV2");
    ...
    return new SaveDatasetV2(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.rawops.SaveDatasetV2}
   */
  ...
  public static class Inputs extends RawOpInputs<SaveDatasetV2> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new SaveDatasetV2(op), op, Arrays.asList("compression", "use_shard_func", "Tshard_func_args", "output_types", "output_shapes"));
      int inputIndex = 0;
