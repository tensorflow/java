 ...
 */
@OpMetadata(
    opType = GetStatsFromListOfSparseCoreCooTensors.OP_NAME,
    inputsClass = GetStatsFromListOfSparseCoreCooTensors.Inputs.class
)
@Operator(
    group = "sparse"
)
public final class GetStatsFromListOfSparseCoreCooTensors extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "GetStatsFromListOfSparseCoreCooTensors";

  private Output<TInt32> maxIdsPerSparseCore;

  private Output<TInt32> maxUniqueIdsPerSparseCore;

  public GetStatsFromListOfSparseCoreCooTensors(Operation operation) {
    super(operation, OP_NAME);
    int outputIdx = 0;
    maxIdsPerSparseCore = operation.output(outputIdx++);
    maxUniqueIdsPerSparseCore = operation.output(outputIdx++);
  }

  /**
   * Factory method to create a class wrapping a new GetStatsFromListOfSparseCoreCooTensors operation.
   *
   ...
   * @return a new instance of GetStatsFromListOfSparseCoreCooTensors
   */
  @Endpoint(
      describeByClass = true
  )
  public static GetStatsFromListOfSparseCoreCooTensors create(Scope scope,
      ...
      String tableName) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "GetStatsFromListOfSparseCoreCooTensors");
    ...
    return new GetStatsFromListOfSparseCoreCooTensors(opBuilder.build());
  }

  /**
   * Gets maxIdsPerSparseCore.
   *
   * @return maxIdsPerSparseCore.
   */
  public Output<TInt32> maxIdsPerSparseCore() {
    return maxIdsPerSparseCore;
  }

  /**
   * Gets maxUniqueIdsPerSparseCore.
   *
   * @return maxUniqueIdsPerSparseCore.
   */
  public Output<TInt32> maxUniqueIdsPerSparseCore() {
    return maxUniqueIdsPerSparseCore;
  }

  @OpInputsMetadata(
      outputsClass = GetStatsFromListOfSparseCoreCooTensors.class
  )
  public static class Inputs extends RawOpInputs<GetStatsFromListOfSparseCoreCooTensors> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new GetStatsFromListOfSparseCoreCooTensors(op), op, Arrays.asList("sample_count_list", "col_offset_list", "num_replica", "table_vocab_size", "feature_width", "num_sc_per_chip", "table_name"));
      int inputIndex = 0;
