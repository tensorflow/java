...
public interface NodeExecStatsOrBuilder extends
   ...
   */
  java.util.List<org.tensorflow.proto.framework.AllocatorMemoryUsed> 
      getMemoryList();
  /**
   * <code>repeated .tensorflow.AllocatorMemoryUsed memory = 6;</code>
   */
  org.tensorflow.proto.framework.AllocatorMemoryUsed getMemory(int index);
  /**
   * <code>repeated .tensorflow.AllocatorMemoryUsed memory = 6;</code>
   */
  int getMemoryCount();
   ...
   * <code>repeated .tensorflow.AllocatorMemoryUsed memory = 6;</code>
   */
  java.util.List<? extends org.tensorflow.proto.framework.AllocatorMemoryUsedOrBuilder> 
      getMemoryOrBuilderList();
  /**
   * <code>repeated .tensorflow.AllocatorMemoryUsed memory = 6;</code>
   */
  org.tensorflow.proto.framework.AllocatorMemoryUsedOrBuilder getMemoryOrBuilder(
      int index);

  /**
   * <code>repeated .tensorflow.NodeOutput output = 7;</code>
   */
  java.util.List<org.tensorflow.proto.framework.NodeOutput> 
      getOutputList();
  /**
   * <code>repeated .tensorflow.NodeOutput output = 7;</code>
   */
  org.tensorflow.proto.framework.NodeOutput getOutput(int index);
  /**
   * <code>repeated .tensorflow.NodeOutput output = 7;</code>
   */
  int getOutputCount();
   ...
   * <code>repeated .tensorflow.NodeOutput output = 7;</code>
   */
  java.util.List<? extends org.tensorflow.proto.framework.NodeOutputOrBuilder> 
      getOutputOrBuilderList();
  /**
   * <code>repeated .tensorflow.NodeOutput output = 7;</code>
   */
  org.tensorflow.proto.framework.NodeOutputOrBuilder getOutputOrBuilder(
      int index);
   ...
   */
  java.util.List<org.tensorflow.proto.framework.AllocationDescription> 
      getReferencedTensorList();
  /**
   * <code>repeated .tensorflow.AllocationDescription referenced_tensor = 11;</code>
   */
  org.tensorflow.proto.framework.AllocationDescription getReferencedTensor(int index);
  /**
   * <code>repeated .tensorflow.AllocationDescription referenced_tensor = 11;</code>
   */
   ...
   * <code>repeated .tensorflow.AllocationDescription referenced_tensor = 11;</code>
   */
  java.util.List<? extends org.tensorflow.proto.framework.AllocationDescriptionOrBuilder> 
      getReferencedTensorOrBuilderList();
  /**
   * <code>repeated .tensorflow.AllocationDescription referenced_tensor = 11;</code>
   */
  org.tensorflow.proto.framework.AllocationDescriptionOrBuilder getReferencedTensorOrBuilder(
      int index);
   ...
   */
  org.tensorflow.proto.framework.MemoryStats getMemoryStats();
  /**
   * <code>.tensorflow.MemoryStats memory_stats = 12;</code>
   */
  org.tensorflow.proto.framework.MemoryStatsOrBuilder getMemoryStatsOrBuilder();
