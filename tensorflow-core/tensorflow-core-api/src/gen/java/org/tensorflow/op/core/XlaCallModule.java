...
public final class XlaCallModule extends RawOp implements Iterable<Operand<TType>> {
  ...
  public static XlaCallModule create(Scope scope, Iterable<Operand<?>> args, String module,
      List<Shape> Sout, List<Class<? extends TType>> Tout, List<String> dimArgsSpec) {
