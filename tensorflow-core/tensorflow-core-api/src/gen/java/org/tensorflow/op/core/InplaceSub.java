 ...
 */
@Operator
public final class InplaceSub<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> InplaceSub<T> create(Scope scope, Operand<T> x, Operand<TInt32> i, Operand<T> v) {
