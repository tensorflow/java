 ...
 */
public final class ReciprocalGrad<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> ReciprocalGrad<T> create(Scope scope, Operand<T> y, Operand<T> dy) {
