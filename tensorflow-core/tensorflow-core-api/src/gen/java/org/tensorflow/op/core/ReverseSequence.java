 ...
 */
@Operator
public final class ReverseSequence<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber> ReverseSequence<T> create(Scope scope, Operand<T> input, Operand<U> seqLengths, Long seqDim, Options... options) {
