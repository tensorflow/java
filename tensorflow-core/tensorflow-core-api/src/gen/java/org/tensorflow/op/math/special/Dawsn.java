 ...
 */
public final class Dawsn<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> Dawsn<T> create(Scope scope, Operand<T> x) {
