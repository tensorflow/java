...
public final class AssertNextDataset extends RawOp implements Operand<TType> {
  ...
  public static AssertNextDataset create(Scope scope, Operand<?> inputDataset, Operand<TString> transformations, List<Class<?>> outputTypes, List<Shape> outputShapes) {
