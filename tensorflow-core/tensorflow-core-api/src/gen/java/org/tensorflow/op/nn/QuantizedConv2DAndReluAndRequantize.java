 ...
 */
@OpMetadata(
    opType = QuantizedConv2DAndReluAndRequantize.OP_NAME,
    inputsClass = QuantizedConv2DAndReluAndRequantize.Inputs.class
)
public final class QuantizedConv2DAndReluAndRequantize<V extends TNumber> extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "QuantizedConv2DAndReluAndRequantize";
  ...
  public QuantizedConv2DAndReluAndRequantize(Operation operation) {
  ...
  public static <V extends TNumber> QuantizedConv2DAndReluAndRequantize<V> create(Scope scope,
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedConv2DAndReluAndRequantize");
    ...
    return new QuantizedConv2DAndReluAndRequantize<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.nn.QuantizedConv2DAndReluAndRequantize}
   */
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedConv2DAndReluAndRequantize.class
  )
  public static class Inputs extends RawOpInputs<QuantizedConv2DAndReluAndRequantize<?>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedConv2DAndReluAndRequantize<>(op), op, Arrays.asList("Tinput", "Tfilter", "out_type", "strides", "padding", "dilations", "padding_list"));
      int inputIndex = 0;
