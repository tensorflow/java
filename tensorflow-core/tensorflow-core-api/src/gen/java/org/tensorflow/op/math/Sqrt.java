...
public final class Sqrt<T extends TType> extends RawOp implements Operand<T> {
   ...
   */
  public static final String OP_NAME = "Sqrt";

  private Output<T> y;

  public Sqrt(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = Sqrt.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<Sqrt<T>> {
    /**
     * The x input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Sqrt<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
