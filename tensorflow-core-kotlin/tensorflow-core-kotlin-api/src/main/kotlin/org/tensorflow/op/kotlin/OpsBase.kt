...
public abstract class OpsBase {
     ...
     * @see LinalgOps.matMul
     */
    public infix fun <T : TType> Operand<T>.matMul(b: Operand<T>): MatMul<T> = matMul(b, transposeB = null)
     ...
     */
    public infix fun <T : TNumber> Operand<T>.lte(b: Operand<T>): LessEqual = tf.math.lessEqual(this, b)

    /**
     * @see MathOps.greaterEqual
     */
    public infix fun <T : TNumber> Operand<T>.gte(b: Operand<T>): GreaterEqual = tf.math.greaterEqual(this, b)
