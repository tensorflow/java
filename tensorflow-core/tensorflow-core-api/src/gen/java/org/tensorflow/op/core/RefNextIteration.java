 ...
 */
@Operator
public final class RefNextIteration<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> RefNextIteration<T> create(Scope scope, Operand<T> data) {
