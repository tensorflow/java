...
public final class Ifft3d<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Ifft3d<T> create(Scope scope, Operand<T> input) {
