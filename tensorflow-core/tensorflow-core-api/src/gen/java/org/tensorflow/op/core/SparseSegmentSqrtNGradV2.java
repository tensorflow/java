 ...
 */
@OpMetadata(
    opType = SparseSegmentSqrtNGradV2.OP_NAME,
    inputsClass = SparseSegmentSqrtNGradV2.Inputs.class
)
@Operator
public final class SparseSegmentSqrtNGradV2<T extends TNumber, U extends TNumber> extends RawOp {
  /**
  ...
  public SparseSegmentSqrtNGradV2(Operation operation) {
  ...
  public static <T extends TNumber, U extends TNumber> SparseSegmentSqrtNGradV2<T, U> create(
      Scope scope, Operand<T> grad, Operand<U> indices, Operand<? extends TNumber> segmentIds,
      Operand<TInt32> denseOutputDim0) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "SparseSegmentSqrtNGradV2");
    opBuilder.addInput(grad.asOutput());
    opBuilder.addInput(indices.asOutput());
    opBuilder.addInput(segmentIds.asOutput());
    opBuilder.addInput(denseOutputDim0.asOutput());
    return new SparseSegmentSqrtNGradV2<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = SparseSegmentSqrtNGradV2.class
  )
  public static class Inputs<T extends TNumber, U extends TNumber> extends RawOpInputs<SparseSegmentSqrtNGradV2<T, U>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new SparseSegmentSqrtNGradV2<>(op), op, Arrays.asList("T", "Tidx", "Tsegmentids"));
      int inputIndex = 0;
