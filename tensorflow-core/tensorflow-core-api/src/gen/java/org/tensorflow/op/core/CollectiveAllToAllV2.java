 ...
 */
@OpMetadata(
    opType = CollectiveAllToAllV2.OP_NAME,
    inputsClass = CollectiveAllToAllV2.Inputs.class
)
public final class CollectiveAllToAllV2<T extends TNumber> extends RawOp implements Operand<T> {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "CollectiveAllToAllV2";

  private Output<T> data;

  public CollectiveAllToAllV2(Operation operation) {
  ...
  /**
   * Factory method to create a class wrapping a new CollectiveAllToAllV2 operation.
   *
   ...
   * @param <T> data type for {@code CollectiveAllToAllV2} output and operands
   * @return a new instance of CollectiveAllToAllV2
   */
  @Endpoint(
      describeByClass = true
  )
  public static <T extends TNumber> CollectiveAllToAllV2<T> create(Scope scope, Operand<T> input,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "CollectiveAllToAllV2");
    ...
    return new CollectiveAllToAllV2<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.CollectiveAllToAllV2}
   */
  ...
  @OpInputsMetadata(
      outputsClass = CollectiveAllToAllV2.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<CollectiveAllToAllV2<T>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new CollectiveAllToAllV2<>(op), op, Arrays.asList("T", "communication_hint", "timeout_seconds", "is_stateless"));
      int inputIndex = 0;
