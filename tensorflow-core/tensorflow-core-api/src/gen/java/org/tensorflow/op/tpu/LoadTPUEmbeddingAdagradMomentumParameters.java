 ...
 */
@OpMetadata(
    opType = LoadTPUEmbeddingAdagradMomentumParameters.OP_NAME,
    inputsClass = LoadTPUEmbeddingAdagradMomentumParameters.Inputs.class
)
public final class LoadTPUEmbeddingAdagradMomentumParameters extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "LoadTPUEmbeddingAdagradMomentumParameters";

  public LoadTPUEmbeddingAdagradMomentumParameters(Operation operation) {
  ...
  public static LoadTPUEmbeddingAdagradMomentumParameters create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LoadTPUEmbeddingAdagradMomentumParameters");
    ...
    return new LoadTPUEmbeddingAdagradMomentumParameters(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.LoadTPUEmbeddingAdagradMomentumParameters}
   */
  ...
  @OpInputsMetadata(
      outputsClass = LoadTPUEmbeddingAdagradMomentumParameters.class
  )
  public static class Inputs extends RawOpInputs<LoadTPUEmbeddingAdagradMomentumParameters> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new LoadTPUEmbeddingAdagradMomentumParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
