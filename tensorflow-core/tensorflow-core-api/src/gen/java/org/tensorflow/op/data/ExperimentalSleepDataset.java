...
public final class ExperimentalSleepDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static ExperimentalSleepDataset create(Scope scope, Operand<?> inputDataset, Operand<Long> sleepMicroseconds, List<Class<?>> outputTypes, List<Shape> outputShapes) {
