 ...
 */
@OpMetadata(
    opType = QuantizedConv2DWithBiasAndReluAndRequantize.OP_NAME,
    inputsClass = QuantizedConv2DWithBiasAndReluAndRequantize.Inputs.class
)
public final class QuantizedConv2DWithBiasAndReluAndRequantize<W extends TNumber> extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "QuantizedConv2DWithBiasAndReluAndRequantize";
  ...
  public QuantizedConv2DWithBiasAndReluAndRequantize(Operation operation) {
  ...
  public static <W extends TNumber> QuantizedConv2DWithBiasAndReluAndRequantize<W> create(
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedConv2DWithBiasAndReluAndRequantize");
    ...
    return new QuantizedConv2DWithBiasAndReluAndRequantize<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.nn.QuantizedConv2DWithBiasAndReluAndRequantize}
   */
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedConv2DWithBiasAndReluAndRequantize.class
  )
  public static class Inputs extends RawOpInputs<QuantizedConv2DWithBiasAndReluAndRequantize<?>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedConv2DWithBiasAndReluAndRequantize<>(op), op, Arrays.asList("Tinput", "Tfilter", "Tbias", "out_type", "strides", "padding", "dilations", "padding_list"));
      int inputIndex = 0;
