 ...
 */
public final class ExperimentalParseExampleDataset extends PrimitiveOp implements Operand<TType> {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.ExperimentalParseExampleDataset}
   */
   ...
   * @return a new instance of ExperimentalParseExampleDataset
   */
  public static ExperimentalParseExampleDataset create(Scope scope, Operand<?> inputDataset, Operand<TInt64> numParallelCalls, Iterable<Operand<?>> denseDefaults, List<String> sparseKeys, List<String> denseKeys, List<DataType<?>> sparseTypes, List<Shape> denseShapes, List<DataType<?>> outputTypes, List<Shape> outputShapes, Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder("ExperimentalParseExampleDataset", scope.makeOpName("ExperimentalParseExampleDataset"));
    ...
    return new ExperimentalParseExampleDataset(opBuilder.build());
  }
  ...
  private ExperimentalParseExampleDataset(Operation operation) {
    super(operation);
    int outputIdx = 0;
