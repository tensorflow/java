...
public final class BitwiseOr<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> BitwiseOr<T> create(Scope scope, Operand<T> x, Operand<T> y) {
