 ...
 */
public final class EluGrad<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> EluGrad<T> create(Scope scope, Operand<T> gradients, Operand<T> outputs) {
