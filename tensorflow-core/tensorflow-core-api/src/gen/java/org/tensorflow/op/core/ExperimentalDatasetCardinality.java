 ...
 * Returns the cardinality of `input_dataset`.
 */
public final class ExperimentalDatasetCardinality extends PrimitiveOp implements Operand<TInt64> {
  ...
  public static ExperimentalDatasetCardinality create(Scope scope, Operand<?> inputDataset) {
    OperationBuilder opBuilder = scope.env().opBuilder("ExperimentalDatasetCardinality", scope.makeOpName("ExperimentalDatasetCardinality"));
