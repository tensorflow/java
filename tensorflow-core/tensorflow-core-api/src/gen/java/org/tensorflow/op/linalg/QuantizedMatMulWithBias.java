...
public final class QuantizedMatMulWithBias<W extends TNumber> extends RawOp {
  ...
  public static <W extends TNumber> QuantizedMatMulWithBias<W> create(Scope scope,
    ...
    return new QuantizedMatMulWithBias<>(opBuilder.build());
  }
  ...
  public static class Inputs extends RawOpInputs<QuantizedMatMulWithBias<?>> {
    ...
    /**
     * A 1D bias tensor with size matching inner dimension of {@code b} (after being
     * transposed if {@code transposed_b} is non-zero).
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedMatMulWithBias<>(op), op, Arrays.asList("T1", "T2", "Tbias", "Toutput", "transpose_a", "transpose_b", "input_quant_mode"));
      int inputIndex = 0;
