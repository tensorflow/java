...
public final class ExperimentalChooseFastestDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static ExperimentalChooseFastestDataset create(Scope scope, Iterable<Operand<?>> inputDatasets, Long numExperiments, List<Class<?>> outputTypes, List<Shape> outputShapes) {
