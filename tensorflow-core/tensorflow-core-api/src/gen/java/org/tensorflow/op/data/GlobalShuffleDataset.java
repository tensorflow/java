 ...
 */
@OpMetadata(
    opType = GlobalShuffleDataset.OP_NAME,
    inputsClass = GlobalShuffleDataset.Inputs.class
)
public final class GlobalShuffleDataset extends RawOp implements Operand<TType> {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "GlobalShuffleDataset";

  private Output<? extends TType> handle;

  @SuppressWarnings("unchecked")
  public GlobalShuffleDataset(Operation operation) {
  ...
  /**
   * Factory method to create a class wrapping a new GlobalShuffleDataset operation.
   *
   ...
   * @return a new instance of GlobalShuffleDataset
   */
  @Endpoint(
      describeByClass = true
  )
  public static GlobalShuffleDataset create(Scope scope, Operand<? extends TType> inputDataset,
      Operand<TInt64> seed, Operand<TInt64> seed2, Operand<? extends TType> seedGenerator,
      List<Class<? extends TType>> outputTypes, List<Shape> outputShapes, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "GlobalShuffleDataset");
    ...
    return new GlobalShuffleDataset(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.data.GlobalShuffleDataset}
   */
  ...
  @OpInputsMetadata(
      outputsClass = GlobalShuffleDataset.class
  )
  public static class Inputs extends RawOpInputs<GlobalShuffleDataset> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new GlobalShuffleDataset(op), op, Arrays.asList("reshuffle_each_iteration", "output_types", "output_shapes", "metadata"));
      int inputIndex = 0;
