...
public final class IntRawDataBuffer extends AbstractRawDataBuffer<Integer, IntDataBuffer>
  ...
  public static IntDataBuffer wrap(int[] array, boolean readOnly) {
    return new IntRawDataBuffer(UnsafeMemoryHandle.of(UNSAFE, array), readOnly);
  }

  public static IntDataBuffer map(Unsafe unsafe, long address, long size, boolean readOnly) {
