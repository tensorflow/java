...
public final class RpcOptions {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tensorflow.RpcOptions.internal_static_tensorflow_RPCOptions_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return tensorflow.RpcOptions.internal_static_tensorflow_RPCOptions_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              tensorflow.RpcOptions.RPCOptions.class, tensorflow.RpcOptions.RPCOptions.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof tensorflow.RpcOptions.RPCOptions)) {
        return super.equals(obj);
      }
      tensorflow.RpcOptions.RPCOptions other = (tensorflow.RpcOptions.RPCOptions) obj;
    ...
    public static tensorflow.RpcOptions.RPCOptions parseFrom(
    ...
    public static tensorflow.RpcOptions.RPCOptions parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static tensorflow.RpcOptions.RPCOptions parseFrom(
    ...
    public static tensorflow.RpcOptions.RPCOptions parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static tensorflow.RpcOptions.RPCOptions parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static tensorflow.RpcOptions.RPCOptions parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(tensorflow.RpcOptions.RPCOptions prototype) {
    ...
    public static final class Builder extends
        ...
        tensorflow.RpcOptions.RPCOptionsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return tensorflow.RpcOptions.internal_static_tensorflow_RPCOptions_descriptor;
      }
      ...
      // Construct using tensorflow.RpcOptions.RPCOptions.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public tensorflow.RpcOptions.RPCOptions getDefaultInstanceForType() {
        return tensorflow.RpcOptions.RPCOptions.getDefaultInstance();
      }

      @java.lang.Override
      public tensorflow.RpcOptions.RPCOptions build() {
        tensorflow.RpcOptions.RPCOptions result = buildPartial();
      ...
      @java.lang.Override
      public tensorflow.RpcOptions.RPCOptions buildPartial() {
        tensorflow.RpcOptions.RPCOptions result = new tensorflow.RpcOptions.RPCOptions(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof tensorflow.RpcOptions.RPCOptions) {
          return mergeFrom((tensorflow.RpcOptions.RPCOptions)other);
        } else {
      ...
      public Builder mergeFrom(tensorflow.RpcOptions.RPCOptions other) {
        if (other == tensorflow.RpcOptions.RPCOptions.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final tensorflow.RpcOptions.RPCOptions DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new tensorflow.RpcOptions.RPCOptions();
    }

    public static tensorflow.RpcOptions.RPCOptions getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n)tensorflow/tsl/protobuf/rpc_options.pr" +
      "oto\022\ntensorflow\"\325\001\n\nRPCOptions\022$\n\034use_rp" +
      "c_for_inprocess_master\030\001 \001(\010\022\035\n\025compress" +
      "ion_algorithm\030\002 \001(\t\022\031\n\021compression_level" +
      "\030\003 \001(\005\022\032\n\022cache_rpc_response\030\004 \001(\010\022*\n\"di" +
      "sable_session_connection_sharing\030\005 \001(\010\022\037" +
      "\n\027num_channels_per_target\030\006 \001(\005B@Z>githu" +
      "b.com/google/tsl/tsl/go/protobuf/for_cor" +
