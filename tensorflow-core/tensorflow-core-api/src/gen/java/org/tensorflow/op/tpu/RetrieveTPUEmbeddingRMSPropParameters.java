 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingRMSPropParameters.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingRMSPropParameters.Inputs.class
)
public final class RetrieveTPUEmbeddingRMSPropParameters extends RawOp {
  /**
  ...
  public RetrieveTPUEmbeddingRMSPropParameters(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingRMSPropParameters create(Scope scope, Long numShards,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingRMSPropParameters");
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingRMSPropParameters.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingRMSPropParameters> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingRMSPropParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
