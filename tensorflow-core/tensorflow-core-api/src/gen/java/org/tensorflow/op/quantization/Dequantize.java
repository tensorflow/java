...
public final class Dequantize<U extends Tensor & TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends Tensor & TNumber, T extends Tensor> Dequantize<U> create(Scope scope, Operand<T> input, Operand<TFloat32> minRange, Operand<TFloat32> maxRange, DataType<U> dtype, Options... options) {
   ...
   */
  @Endpoint(describeByClass = true)
  public static <T extends Tensor> Dequantize<TFloat32> create(Scope scope, Operand<T> input, Operand<TFloat32> minRange, Operand<TFloat32> maxRange, Options... options) {
