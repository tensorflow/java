...
public final class PreventGradient<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> PreventGradient<T> create(Scope scope, Operand<T> input, Options... options) {
