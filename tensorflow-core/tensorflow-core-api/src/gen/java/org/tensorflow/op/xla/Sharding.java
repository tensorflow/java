 ...
 */
@Operator(group = "xla")
public final class Sharding<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Sharding<T> create(Scope scope, Operand<T> input) {
