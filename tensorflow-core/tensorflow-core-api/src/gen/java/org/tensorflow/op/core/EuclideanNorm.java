 ...
 */
@Operator
public final class EuclideanNorm<T> extends PrimitiveOp implements Operand<T> {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.EuclideanNorm}
   */
   ...
   */
  public static <T, U extends TNumber> EuclideanNorm<T> create(Scope scope, Operand<T> input, Operand<U> axis, Options... options) {
    ...
    return new EuclideanNorm<T>(opBuilder.build());
  }
