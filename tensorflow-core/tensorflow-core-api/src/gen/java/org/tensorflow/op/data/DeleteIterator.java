 ...
 */
@OpMetadata(
    opType = DeleteIterator.OP_NAME,
    inputsClass = DeleteIterator.Inputs.class
)
@Operator(
    group = "data"
)
public final class DeleteIterator extends RawOp {
  ...
  public static DeleteIterator create(Scope scope, Operand<? extends TType> handle,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "DeleteIterator");
  ...
  @OpInputsMetadata(
      outputsClass = DeleteIterator.class
  )
  public static class Inputs extends RawOpInputs<DeleteIterator> {
    ...
    public Inputs(GraphOperation op) {
      super(new DeleteIterator(op), op, Arrays.asList());
      int inputIndex = 0;
