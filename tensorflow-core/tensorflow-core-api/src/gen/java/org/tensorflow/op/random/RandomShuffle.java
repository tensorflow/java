...
public final class RandomShuffle<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> RandomShuffle<T> create(Scope scope, Operand<T> value, Options... options) {
