 ...
 */
@OpMetadata(
    opType = ParallelFilterDataset.OP_NAME,
    inputsClass = ParallelFilterDataset.Inputs.class
)
public final class ParallelFilterDataset extends RawOp implements Operand<TType> {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "ParallelFilterDataset";

  private Output<? extends TType> handle;

  @SuppressWarnings("unchecked")
  public ParallelFilterDataset(Operation operation) {
  ...
  public static ParallelFilterDataset create(Scope scope, Operand<? extends TType> inputDataset,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "ParallelFilterDataset");
    ...
    return new ParallelFilterDataset(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.data.ParallelFilterDataset}
   */
  ...
  @OpInputsMetadata(
      outputsClass = ParallelFilterDataset.class
  )
  public static class Inputs extends RawOpInputs<ParallelFilterDataset> {
    /**
    ...
    /**
     * The number of concurrent invocations of {@code predicate} that process
     * elements from {@code input_dataset} in parallel.
     */
    ...
    public Inputs(GraphOperation op) {
      super(new ParallelFilterDataset(op), op, Arrays.asList("deterministic", "Targuments", "output_types", "output_shapes", "metadata"));
      int inputIndex = 0;
