 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingAdadeltaParameters.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingAdadeltaParameters.Inputs.class
)
public final class RetrieveTPUEmbeddingAdadeltaParameters extends RawOp {
  ...
  public RetrieveTPUEmbeddingAdadeltaParameters(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingAdadeltaParameters create(Scope scope, Long numShards,
      Long shardId, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingAdadeltaParameters");
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingAdadeltaParameters.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingAdadeltaParameters> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingAdadeltaParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
