 ...
 */
@Operator(group = "math")
public final class Igamma<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> Igamma<T> create(Scope scope, Operand<T> a, Operand<T> x) {
