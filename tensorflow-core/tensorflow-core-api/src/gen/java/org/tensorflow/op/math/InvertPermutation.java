 ...
 */
@Operator(group = "math")
public final class InvertPermutation<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> InvertPermutation<T> create(Scope scope, Operand<T> x) {
