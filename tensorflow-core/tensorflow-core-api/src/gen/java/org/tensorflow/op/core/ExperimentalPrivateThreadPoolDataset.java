...
public final class ExperimentalPrivateThreadPoolDataset extends PrimitiveOp implements Operand<Object> {
   ...
   */
  public static ExperimentalPrivateThreadPoolDataset create(Scope scope, Operand<?> inputDataset, Operand<Long> numThreads, List<Class<?>> outputTypes, List<Shape> outputShapes) {
