 ...
 */
public class MeanSquaredLogarithmicError<T extends TNumber> extends MeanBaseMetricWrapper<T>
   ...
   */
  public MeanSquaredLogarithmicError(long seed, Class<T> type) {
    this(null, seed, type);
  }
   ...
   * @param type the type for the variables and result
   */
  public MeanSquaredLogarithmicError(String name, long seed, Class<T> type) {
  ...
  public <U extends TNumber> Operand<U> call(
    ...
    return Losses.meanSquaredLogarithmicError(tf, tLabels, tPredictions);
  }
}
