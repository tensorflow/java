 ...
 *
 * <p>A slice, i.e. a reduced view, of an N-dimensional array is obtain by calling {@link
 * NdArray#slice(Index...)}, given a list of indices that select which elements on a given dimension
 * should be included/excluded from that view.
 */
public interface Index {
   ...
   *
   * <p>An index that maps one-by-one all elements of the dimensions will return a value equal to
   * {@code dim.numElements()}, while an index that only maps a subset of these will return a
   * smaller value.
   *
   ...
   *
   * <p>When accessing the elements from the returned dimension, this index will automatically apply
   * and may transform the original position.
   *
  ...
  /**
   * Get whether the Index supports strided slice style indexing (using start, end, stride, and
   * flags, i.e. <a
  ...
  /**
   * Get whether the Index should start at the beginning of the dimension, for strided slice style
   * indexing.
   */
  ...
  /**
   * Get whether the Index should end at the beginning of the dimension, for strided slice style
   * indexing.
   */
