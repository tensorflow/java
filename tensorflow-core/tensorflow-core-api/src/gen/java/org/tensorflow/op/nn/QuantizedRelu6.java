 ...
 */
@Operator(group = "nn")
public final class QuantizedRelu6<U extends TType> extends PrimitiveOp {
   ...
   */
  public static <U extends TType, T extends TType> QuantizedRelu6<U> create(Scope scope, Operand<T> features, Operand<TFloat> minFeatures, Operand<TFloat> maxFeatures, DataType<U> outType) {
