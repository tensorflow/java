...
public final class ResourceSparseApplyAdagradV2 extends RawOp {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber> ResourceSparseApplyAdagradV2 create(Scope scope, Operand<?> var, Operand<?> accum, Operand<T> lr, Operand<T> epsilon, Operand<T> grad, Operand<U> indices, Options... options) {
