...
private static final long serialVersionUID = 0L;
  ...
  private static final long serialVersionUID = 0L;
     ...
     * @return The mlirBridgeRollout.
     */
    @java.lang.Override public org.tensorflow.proto.framework.ConfigProto.Experimental.MlirBridgeRollout getMlirBridgeRollout() {
  ...
  private tensorflow.RpcOptions.RPCOptions rpcOptions_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public tensorflow.RpcOptions.RPCOptions getRpcOptions() {
    return rpcOptions_ == null ? tensorflow.RpcOptions.RPCOptions.getDefaultInstance() : rpcOptions_;
  }
  /**
   * <pre>
   * Options that apply when this session uses the distributed runtime.
   ...
   */
  @java.lang.Override
  public tensorflow.RpcOptions.RPCOptionsOrBuilder getRpcOptionsOrBuilder() {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98: {
              org.tensorflow.proto.framework.ThreadPoolOptionProto m =
                  input.readMessage(
                      org.tensorflow.proto.framework.ThreadPoolOptionProto.parser(),
                      extensionRegistry);
              if (sessionInterOpThreadPoolBuilder_ == null) {
                ensureSessionInterOpThreadPoolIsMutable();
  ...
  checkByteStringIsUtf8(value);
    ...
    private tensorflow.RpcOptions.RPCOptions rpcOptions_;
    private com.google.protobuf.SingleFieldBuilderV3<
        tensorflow.RpcOptions.RPCOptions, tensorflow.RpcOptions.RPCOptions.Builder, tensorflow.RpcOptions.RPCOptionsOrBuilder> rpcOptionsBuilder_;
    /**
     * <pre>
     * Options that apply when this session uses the distributed runtime.
     * </pre>
     ...
     * <code>.tensorflow.RPCOptions rpc_options = 13;</code>
     */
    public Builder setRpcOptions(tensorflow.RpcOptions.RPCOptions value) {
      if (rpcOptionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setRpcOptions(
        tensorflow.RpcOptions.RPCOptions.Builder builderForValue) {
      if (rpcOptionsBuilder_ == null) {
     ...
     * <code>.tensorflow.RPCOptions rpc_options = 13;</code>
     */
    public Builder mergeRpcOptions(tensorflow.RpcOptions.RPCOptions value) {
      if (rpcOptionsBuilder_ == null) {
        if (rpcOptions_ != null) {
          rpcOptions_ =
            tensorflow.RpcOptions.RPCOptions.newBuilder(rpcOptions_).mergeFrom(value).buildPartial();
        } else {
          rpcOptions_ = value;
        }
        onChanged();
     ...
     * <code>.tensorflow.RPCOptions rpc_options = 13;</code>
     */
    public tensorflow.RpcOptions.RPCOptions.Builder getRpcOptionsBuilder() {
    ...
    public tensorflow.RpcOptions.RPCOptionsOrBuilder getRpcOptionsOrBuilder() {
      if (rpcOptionsBuilder_ != null) {
        ...
        return rpcOptions_ == null ?
            tensorflow.RpcOptions.RPCOptions.getDefaultInstance() : rpcOptions_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        tensorflow.RpcOptions.RPCOptions, tensorflow.RpcOptions.RPCOptions.Builder, tensorflow.RpcOptions.RPCOptionsOrBuilder> 
