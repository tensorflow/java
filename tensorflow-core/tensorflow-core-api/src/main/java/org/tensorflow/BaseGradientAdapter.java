...
//import org.tensorflow.internal.c_api.NativeNode;
//import org.tensorflow.internal.c_api.TF_Operation;
//
///** Helper base class for custom gradient adapters <b>INTERNAL USE ONLY</b> */
//public abstract class BaseGradientAdapter extends NativeGradFunc {
//
...
//      NativeNode node = ((GraphOperation) output.op()).getUnsafeNativeHandle().node();
//      nativeOutputs.put(i, new NativeOutput(node, output.index()));
//    }
//  }
//
//  /**
//   * Make a {@link GraphOperation} from a native {@link NativeNode}
//   *
//   * @param g the graph the operation is in
//   * @param node the native node
//   * @return a graph operation with the underlying native node
//   */
//  protected static GraphOperation getGraphOp(Graph g, NativeNode node) {
