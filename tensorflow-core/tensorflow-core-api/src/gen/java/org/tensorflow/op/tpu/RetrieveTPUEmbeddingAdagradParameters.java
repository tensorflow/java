 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingAdagradParameters.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingAdagradParameters.Inputs.class
)
public final class RetrieveTPUEmbeddingAdagradParameters extends RawOp {
  /**
  ...
  public RetrieveTPUEmbeddingAdagradParameters(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingAdagradParameters create(Scope scope, Long numShards,
      Long shardId, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingAdagradParameters");
    ...
    return new RetrieveTPUEmbeddingAdagradParameters(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.RetrieveTPUEmbeddingAdagradParameters}
   */
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingAdagradParameters.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingAdagradParameters> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingAdagradParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
