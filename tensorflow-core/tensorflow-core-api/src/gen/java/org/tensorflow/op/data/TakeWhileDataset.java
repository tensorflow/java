...
public final class TakeWhileDataset extends RawOp implements Operand<TType> {
   ...
   */
  public static final String OP_NAME = "TakeWhileDataset";
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.data.TakeWhileDataset}
   */
  ...
  public static class Inputs extends RawOpInputs<TakeWhileDataset> {
    ...
    public Inputs(GraphOperation op) {
      super(new TakeWhileDataset(op), op, Arrays.asList("Targuments", "output_types", "output_shapes", "metadata"));
      int inputIndex = 0;
