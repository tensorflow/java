 ...
 */
@Operator(group = "nn")
public final class QuantizedRelu6<U extends Tensor> extends RawOp {
  ...
  public static <U extends Tensor, T extends Tensor> QuantizedRelu6<U> create(Scope scope, Operand<T> features, Operand<TFloat32> minFeatures, Operand<TFloat32> maxFeatures, DataType<U> outType) {
