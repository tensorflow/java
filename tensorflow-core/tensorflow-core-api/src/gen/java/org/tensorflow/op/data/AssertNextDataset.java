...
public final class AssertNextDataset extends RawOp implements Operand<TType> {
   ...
   * @param transformations A `tf.string` vector `tf.Tensor` identifying the transformations that are
  ...
  public static AssertNextDataset create(Scope scope, Operand<?> inputDataset, Operand<TString> transformations, List<Class<? extends TType>> outputTypes, List<Shape> outputShapes) {
