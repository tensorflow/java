 ...
 *
 * <p>If {@code sampleWeights} is given, calculates the sum of the weights of false negatives. This
...
public class FalseNegatives<T extends TNumber> extends ConfusionMatrixConditionCount<T> {
   ...
   */
  public FalseNegatives(long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalseNegatives(float threshold, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalseNegatives(float[] thresholds, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalseNegatives(String name, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalseNegatives(String name, float threshold, long seed, Class<T> type) {
   ...
   * @param type the data type for the variables
   */
  public FalseNegatives(String name, float[] thresholds, long seed, Class<T> type) {
    super(name, ConfusionMatrixEnum.FALSE_NEGATIVES, thresholds, seed, type);
  }
}
