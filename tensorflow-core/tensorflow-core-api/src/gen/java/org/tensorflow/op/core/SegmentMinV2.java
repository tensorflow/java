 ...
 */
@OpMetadata(
    opType = SegmentMinV2.OP_NAME,
    inputsClass = SegmentMinV2.Inputs.class
)
@Operator
public final class SegmentMinV2<T extends TNumber> extends RawOp implements Operand<T> {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "SegmentMinV2";

  private Output<T> output;

  public SegmentMinV2(Operation operation) {
  ...
  public static <T extends TNumber> SegmentMinV2<T> create(Scope scope, Operand<T> data,
      Operand<? extends TNumber> segmentIds, Operand<? extends TNumber> numSegments) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "SegmentMinV2");
    opBuilder.addInput(data.asOutput());
    opBuilder.addInput(segmentIds.asOutput());
    opBuilder.addInput(numSegments.asOutput());
    return new SegmentMinV2<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = SegmentMinV2.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<SegmentMinV2<T>> {
    /**
     * The data input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new SegmentMinV2<>(op), op, Arrays.asList("T", "Tindices", "Tnumsegments"));
      int inputIndex = 0;
