 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug";
  ...
  public RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug create(Scope scope,
      Long numShards, Long shardId, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug");
    ...
    return new RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug}
   */
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingRMSPropParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
