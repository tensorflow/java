 ...
 */
@OpMetadata(
    opType = ResourceApplyMomentum.OP_NAME,
    inputsClass = ResourceApplyMomentum.Inputs.class
)
@Operator(
    group = "train"
)
public final class ResourceApplyMomentum extends RawOp {
  ...
  public ResourceApplyMomentum(Operation operation) {
  ...
  public static <T extends TType> ResourceApplyMomentum create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "ResourceApplyMomentum");
  ...
  @OpInputsMetadata(
      outputsClass = ResourceApplyMomentum.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<ResourceApplyMomentum> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new ResourceApplyMomentum(op), op, Arrays.asList("T", "use_locking", "use_nesterov"));
      int inputIndex = 0;
