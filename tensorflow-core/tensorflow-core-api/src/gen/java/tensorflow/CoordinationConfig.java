...
public final class CoordinationConfig {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tensorflow.CoordinationConfig.internal_static_tensorflow_CoordinatedJob_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return tensorflow.CoordinationConfig.internal_static_tensorflow_CoordinatedJob_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              tensorflow.CoordinationConfig.CoordinatedJob.class, tensorflow.CoordinationConfig.CoordinatedJob.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof tensorflow.CoordinationConfig.CoordinatedJob)) {
        return super.equals(obj);
      }
      tensorflow.CoordinationConfig.CoordinatedJob other = (tensorflow.CoordinationConfig.CoordinatedJob) obj;
    ...
    public static tensorflow.CoordinationConfig.CoordinatedJob parseFrom(
    ...
    public static tensorflow.CoordinationConfig.CoordinatedJob parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static tensorflow.CoordinationConfig.CoordinatedJob parseFrom(
    ...
    public static tensorflow.CoordinationConfig.CoordinatedJob parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static tensorflow.CoordinationConfig.CoordinatedJob parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static tensorflow.CoordinationConfig.CoordinatedJob parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(tensorflow.CoordinationConfig.CoordinatedJob prototype) {
    ...
    public static final class Builder extends
        ...
        tensorflow.CoordinationConfig.CoordinatedJobOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return tensorflow.CoordinationConfig.internal_static_tensorflow_CoordinatedJob_descriptor;
      }
      ...
      // Construct using tensorflow.CoordinationConfig.CoordinatedJob.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public tensorflow.CoordinationConfig.CoordinatedJob getDefaultInstanceForType() {
        return tensorflow.CoordinationConfig.CoordinatedJob.getDefaultInstance();
      }

      @java.lang.Override
      public tensorflow.CoordinationConfig.CoordinatedJob build() {
        tensorflow.CoordinationConfig.CoordinatedJob result = buildPartial();
      ...
      @java.lang.Override
      public tensorflow.CoordinationConfig.CoordinatedJob buildPartial() {
        tensorflow.CoordinationConfig.CoordinatedJob result = new tensorflow.CoordinationConfig.CoordinatedJob(this);
        result.name_ = name_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof tensorflow.CoordinationConfig.CoordinatedJob) {
          return mergeFrom((tensorflow.CoordinationConfig.CoordinatedJob)other);
        } else {
      ...
      public Builder mergeFrom(tensorflow.CoordinationConfig.CoordinatedJob other) {
        if (other == tensorflow.CoordinationConfig.CoordinatedJob.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final tensorflow.CoordinationConfig.CoordinatedJob DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new tensorflow.CoordinationConfig.CoordinatedJob();
    }

    public static tensorflow.CoordinationConfig.CoordinatedJob getDefaultInstance() {
  ...
  public interface CoordinationServiceConfigOrBuilder extends
     ...
     */
    java.util.List<tensorflow.CoordinationConfig.CoordinatedJob> 
        getCoordinatedJobListList();
    /**
     * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
     */
    tensorflow.CoordinationConfig.CoordinatedJob getCoordinatedJobList(int index);
    /**
     * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
     */
     ...
     * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
     */
    java.util.List<? extends tensorflow.CoordinationConfig.CoordinatedJobOrBuilder> 
        getCoordinatedJobListOrBuilderList();
    /**
     * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
     */
    tensorflow.CoordinationConfig.CoordinatedJobOrBuilder getCoordinatedJobListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    private java.util.List<tensorflow.CoordinationConfig.CoordinatedJob> coordinatedJobList_;
    /**
     * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
     */
    @java.lang.Override
    public java.util.List<tensorflow.CoordinationConfig.CoordinatedJob> getCoordinatedJobListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends tensorflow.CoordinationConfig.CoordinatedJobOrBuilder> 
        getCoordinatedJobListOrBuilderList() {
      return coordinatedJobList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public tensorflow.CoordinationConfig.CoordinatedJob getCoordinatedJobList(int index) {
     ...
     */
    @java.lang.Override
    public tensorflow.CoordinationConfig.CoordinatedJobOrBuilder getCoordinatedJobListOrBuilder(
        int index) {
      return coordinatedJobList_.get(index);
    }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 82: {
                tensorflow.CoordinationConfig.CoordinatedJob m =
                    input.readMessage(
                        tensorflow.CoordinationConfig.CoordinatedJob.parser(),
                        extensionRegistry);
                if (coordinatedJobListBuilder_ == null) {
                  ensureCoordinatedJobListIsMutable();
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureCoordinatedJobListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          coordinatedJobList_ = new java.util.ArrayList<tensorflow.CoordinationConfig.CoordinatedJob>(coordinatedJobList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          tensorflow.CoordinationConfig.CoordinatedJob, tensorflow.CoordinationConfig.CoordinatedJob.Builder, tensorflow.CoordinationConfig.CoordinatedJobOrBuilder> coordinatedJobListBuilder_;
      ...
      public Builder setCoordinatedJobList(
          int index, tensorflow.CoordinationConfig.CoordinatedJob value) {
        if (coordinatedJobListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCoordinatedJobList(
          int index, tensorflow.CoordinationConfig.CoordinatedJob.Builder builderForValue) {
        if (coordinatedJobListBuilder_ == null) {
          ensureCoordinatedJobListIsMutable();
       ...
       * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
       */
      public Builder addCoordinatedJobList(tensorflow.CoordinationConfig.CoordinatedJob value) {
        if (coordinatedJobListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCoordinatedJobList(
          tensorflow.CoordinationConfig.CoordinatedJob.Builder builderForValue) {
        if (coordinatedJobListBuilder_ == null) {
          ensureCoordinatedJobListIsMutable();
      ...
      public Builder addAllCoordinatedJobList(
          java.lang.Iterable<? extends tensorflow.CoordinationConfig.CoordinatedJob> values) {
        if (coordinatedJobListBuilder_ == null) {
          ensureCoordinatedJobListIsMutable();
       ...
       * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
       */
      public tensorflow.CoordinationConfig.CoordinatedJob.Builder getCoordinatedJobListBuilder(
          int index) {
       ...
       * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
       */
      public tensorflow.CoordinationConfig.CoordinatedJob.Builder addCoordinatedJobListBuilder() {
        return getCoordinatedJobListFieldBuilder().addBuilder(
            tensorflow.CoordinationConfig.CoordinatedJob.getDefaultInstance());
      }
      /**
       * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
       */
      public tensorflow.CoordinationConfig.CoordinatedJob.Builder addCoordinatedJobListBuilder(
          int index) {
        return getCoordinatedJobListFieldBuilder().addBuilder(
            index, tensorflow.CoordinationConfig.CoordinatedJob.getDefaultInstance());
      }
      /**
       * <code>repeated .tensorflow.CoordinatedJob coordinated_job_list = 10;</code>
       */
      public java.util.List<tensorflow.CoordinationConfig.CoordinatedJob.Builder> 
           getCoordinatedJobListBuilderList() {
        return getCoordinatedJobListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          tensorflow.CoordinationConfig.CoordinatedJob, tensorflow.CoordinationConfig.CoordinatedJob.Builder, tensorflow.CoordinationConfig.CoordinatedJobOrBuilder> 
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n1tensorflow/tsl/protobuf/coordination_c" +
      "onfig.proto\022\ntensorflow\"1\n\016CoordinatedJo" +
      "b\022\014\n\004name\030\001 \001(\t\022\021\n\tnum_tasks\030\002 \001(\005\"\335\002\n\031C" +
      "oordinationServiceConfig\022\024\n\014service_type" +
      "\030\001 \001(\t\022\026\n\016service_leader\030\002 \001(\t\022\033\n\023enable" +
      "_health_check\030\003 \001(\010\022&\n\036cluster_register_" +
      "timeout_in_ms\030\004 \001(\003\022\037\n\027heartbeat_timeout" +
      "_in_ms\030\005 \001(\003\0228\n\024coordinated_job_list\030\n \003" +
      "(\0132\032.tensorflow.CoordinatedJob\022&\n\036shutdo" +
      "wn_barrier_timeout_in_ms\030\007 \001(\003\022*\n\"agent_" +
      "destruction_without_shutdown\030\010 \001(\010\022\030\n\020re" +
      "coverable_jobs\030\t \003(\tJ\004\010\006\020\007BWZUgithub.com" +
    ...
    internal_static_tensorflow_CoordinationServiceConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_CoordinationServiceConfig_descriptor,
        new java.lang.String[] { "ServiceType", "ServiceLeader", "EnableHealthCheck", "ClusterRegisterTimeoutInMs", "HeartbeatTimeoutInMs", "CoordinatedJobList", "ShutdownBarrierTimeoutInMs", "AgentDestructionWithoutShutdown", "RecoverableJobs", });
  }
