 ...
 */
@OpMetadata(
    opType = BatchFft2d.OP_NAME,
    inputsClass = BatchFft2d.Inputs.class
)
@Operator(
    group = "signal"
)
public final class BatchFft2d extends RawOp implements Operand<TType> {
  ...
  public BatchFft2d(Operation operation) {
  ...
  public static BatchFft2d create(Scope scope, Operand<? extends TType> input) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "BatchFft2d");
  ...
  @OpInputsMetadata(
      outputsClass = BatchFft2d.class
  )
  public static class Inputs extends RawOpInputs<BatchFft2d> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new BatchFft2d(op), op, Arrays.asList());
      int inputIndex = 0;
