 ...
 * executed.
 */
public final class LoadTPUEmbeddingRMSPropParametersGradAccumDebug extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.LoadTPUEmbeddingRMSPropParametersGradAccumDebug}
   */
   ...
   */
  public static LoadTPUEmbeddingRMSPropParametersGradAccumDebug create(Scope scope, Operand<Float> parameters, Operand<Float> ms, Operand<Float> mom, Operand<Float> gradientAccumulators, Long numShards, Long shardId, Options... options) {
