 ...
 */
@Operator
public final class ReduceProd<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber> ReduceProd<T> create(Scope scope, Operand<T> input, Operand<U> axis, Options... options) {
