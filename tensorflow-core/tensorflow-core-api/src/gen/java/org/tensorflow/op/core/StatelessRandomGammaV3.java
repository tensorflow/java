 ...
 */
@OpMetadata(
    opType = StatelessRandomGammaV3.OP_NAME,
    inputsClass = StatelessRandomGammaV3.Inputs.class
)
public final class StatelessRandomGammaV3<U extends TNumber> extends RawOp implements Operand<U> {
  /**
  ...
  public StatelessRandomGammaV3(Operation operation) {
   ...
   * @return a new instance of StatelessRandomGammaV3
   */
  @Endpoint(
      describeByClass = true
  )
  public static <U extends TNumber> StatelessRandomGammaV3<U> create(Scope scope,
      Operand<? extends TNumber> shape, Operand<? extends TType> key,
      Operand<? extends TType> counter, Operand<TInt32> alg, Operand<U> alpha) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "StatelessRandomGammaV3");
    opBuilder.addInput(shape.asOutput());
    opBuilder.addInput(key.asOutput());
    opBuilder.addInput(counter.asOutput());
    opBuilder.addInput(alg.asOutput());
    opBuilder.addInput(alpha.asOutput());
    return new StatelessRandomGammaV3<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = StatelessRandomGammaV3.class
  )
  public static class Inputs<U extends TNumber> extends RawOpInputs<StatelessRandomGammaV3<U>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new StatelessRandomGammaV3<>(op), op, Arrays.asList("dtype", "shape_dtype"));
      int inputIndex = 0;
