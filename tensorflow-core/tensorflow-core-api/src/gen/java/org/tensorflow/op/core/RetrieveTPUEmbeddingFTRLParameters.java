 ...
 */
public final class RetrieveTPUEmbeddingFTRLParameters extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.RetrieveTPUEmbeddingFTRLParameters}
   */
  ...
  private RetrieveTPUEmbeddingFTRLParameters(Operation operation) {
    super(operation);
    int outputIdx = 0;
