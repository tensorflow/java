...
public final class LoadTPUEmbeddingFTRLParameters extends RawOp {
  ...
  public LoadTPUEmbeddingFTRLParameters(Operation operation) {
  ...
  public static LoadTPUEmbeddingFTRLParameters create(Scope scope, Operand<TFloat32> parameters,
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LoadTPUEmbeddingFTRLParameters");
  ...
  @OpInputsMetadata(
      outputsClass = LoadTPUEmbeddingFTRLParameters.class
  )
  public static class Inputs extends RawOpInputs<LoadTPUEmbeddingFTRLParameters> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new LoadTPUEmbeddingFTRLParameters(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
