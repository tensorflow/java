 ...
 */
@Operator(group = "math")
public final class DivNoNan<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> DivNoNan<T> create(Scope scope, Operand<T> x, Operand<T> y) {
