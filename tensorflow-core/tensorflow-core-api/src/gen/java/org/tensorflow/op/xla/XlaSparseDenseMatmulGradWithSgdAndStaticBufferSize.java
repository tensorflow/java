...
public final class XlaSparseDenseMatmulGradWithSgdAndStaticBufferSize extends RawOp implements Operand<TFloat32> {
  ...
  public static class Inputs extends RawOpInputs<XlaSparseDenseMatmulGradWithSgdAndStaticBufferSize> {
    ...
    public Inputs(GraphOperation op) {
      super(new XlaSparseDenseMatmulGradWithSgdAndStaticBufferSize(op), op, Arrays.asList("clip_weight_min", "clip_weight_max", "max_ids_per_sparse_core", "max_unique_ids_per_sparse_core", "table_name", "num_sparsecores_per_device"));
      int inputIndex = 0;
