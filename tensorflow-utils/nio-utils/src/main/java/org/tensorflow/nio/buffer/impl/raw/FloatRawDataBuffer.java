...
public final class FloatRawDataBuffer extends AbstractRawDataBuffer<Float, FloatDataBuffer>
  ...
  public static FloatDataBuffer wrap(float[] array, boolean readOnly) {
    return new FloatRawDataBuffer(UnsafeMemoryHandle.of(UNSAFE, array), readOnly);
  }

  public static FloatDataBuffer map(Unsafe unsafe, long address, long size, boolean readOnly) {
