 ...
 */
@OpMetadata(
    opType = OrderedMapClear.OP_NAME,
    inputsClass = OrderedMapClear.Inputs.class
)
@Operator
public final class OrderedMapClear extends RawOp {
  ...
  public OrderedMapClear(Operation operation) {
  ...
  public static OrderedMapClear create(Scope scope, List<Class<? extends TType>> dtypes,
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "OrderedMapClear");
  ...
  @OpInputsMetadata(
      outputsClass = OrderedMapClear.class
  )
  public static class Inputs extends RawOpInputs<OrderedMapClear> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new OrderedMapClear(op), op, Arrays.asList("capacity", "memory_limit", "dtypes", "container", "shared_name"));
      int inputIndex = 0;
