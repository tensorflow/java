...
public class InputTest {
  ...
  void call() {
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      Input<TFloat32> instance = new Input<>(tf, input, TFloat32.class);
      List<Operand<TFloat32>> result =
          instance.call(Collections.singletonList(input), null, false, TFloat32.class);
  ...
  void isPlaceholder() {
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      Input<TFloat32> instance =
          new Input<>(
              tf, TFloat32.class, TFloat32.class, Layer.Options.create().inputShape(input.shape()));
