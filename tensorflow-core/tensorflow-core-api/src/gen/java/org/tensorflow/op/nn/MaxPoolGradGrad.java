...
public final class MaxPoolGradGrad<T extends Number> extends PrimitiveOp implements Operand<T> {
   ...
   */
  public static <T extends Number> MaxPoolGradGrad<T> create(Scope scope, Operand<T> origInput, Operand<T> origOutput, Operand<T> grad, Operand<Integer> ksize, Operand<Integer> strides, String padding, Options... options) {
