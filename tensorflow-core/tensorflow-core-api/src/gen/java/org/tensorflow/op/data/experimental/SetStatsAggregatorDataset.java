...
public final class SetStatsAggregatorDataset extends RawOp implements Operand<TType> {
  ...
  public static SetStatsAggregatorDataset create(Scope scope, Operand<?> inputDataset, Operand<?> statsAggregator, Operand<TString> tag, Operand<TString> counterPrefix, List<Class<?>> outputTypes, List<Shape> outputShapes) {
    ...
    opBuilder.addInput(counterPrefix.asOutput(scope));
