 ...
 */
@Operator(group = "math")
public final class Pow<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Pow<T> create(Scope scope, Operand<T> x, Operand<T> y) {
