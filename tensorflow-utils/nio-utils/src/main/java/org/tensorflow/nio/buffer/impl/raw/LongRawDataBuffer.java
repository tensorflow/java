...
public final class LongRawDataBuffer extends AbstractRawDataBuffer<Long, LongDataBuffer>
  ...
  public static LongDataBuffer wrap(long[] array, boolean readOnly) {
    return new LongRawDataBuffer(UnsafeMemoryHandle.of(UNSAFE, array), readOnly);
  }

  public static LongDataBuffer map(Unsafe unsafe, long address, long size, boolean readOnly) {
