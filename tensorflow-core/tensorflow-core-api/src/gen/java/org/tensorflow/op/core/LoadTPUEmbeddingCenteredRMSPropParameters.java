 ...
 * executed.
 */
public final class LoadTPUEmbeddingCenteredRMSPropParameters extends PrimitiveOp {
  
  /**
   * Optional attributes for {@link org.tensorflow.op.core.LoadTPUEmbeddingCenteredRMSPropParameters}
   */
   ...
   */
  public static LoadTPUEmbeddingCenteredRMSPropParameters create(Scope scope, Operand<Float> parameters, Operand<Float> ms, Operand<Float> mom, Operand<Float> mg, Long numShards, Long shardId, Options... options) {
