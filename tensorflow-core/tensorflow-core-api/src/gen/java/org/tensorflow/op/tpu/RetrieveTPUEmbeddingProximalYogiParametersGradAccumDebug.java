...
/**
 * The RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug operation
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug extends RawOp {
  ...
  public RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingProximalYogiParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
