...
public final class MapClear extends RawOp {
  ...
  public static MapClear create(Scope scope, List<Class<? extends TType>> dtypes,
      Options... options) {
    OperationBuilder opBuilder = scope.env().opBuilder("MapClear", scope.makeOpName("MapClear"));
