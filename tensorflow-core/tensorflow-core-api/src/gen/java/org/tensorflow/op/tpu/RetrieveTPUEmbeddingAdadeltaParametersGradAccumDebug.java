...
public final class RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug extends RawOp {
  ...
  public static RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug create(Scope scope,
      Long numShards, Long shardId, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug");
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug}
   */
  ...
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug> {
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingAdadeltaParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
