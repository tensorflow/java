 ...
 */
@Operator(group = "nn")
public final class LocalResponseNormalization<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> LocalResponseNormalization<T> create(Scope scope, Operand<T> input, Options... options) {
