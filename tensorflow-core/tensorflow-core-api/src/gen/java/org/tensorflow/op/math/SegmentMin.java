 ...
 */
@OpMetadata(
    opType = SegmentMin.OP_NAME,
    inputsClass = SegmentMin.Inputs.class
)
@Operator(
    group = "math"
)
public final class SegmentMin<T extends TNumber> extends RawOp implements Operand<T> {
  ...
  public SegmentMin(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = SegmentMin.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<SegmentMin<T>> {
    /**
     * The data input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new SegmentMin<>(op), op, Arrays.asList("T", "Tindices", "Tnumsegments"));
      int inputIndex = 0;
