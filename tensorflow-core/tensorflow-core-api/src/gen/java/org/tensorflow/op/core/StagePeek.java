 ...
 */
@OpMetadata(
    opType = StagePeek.OP_NAME,
    inputsClass = StagePeek.Inputs.class
)
@Operator
public final class StagePeek extends RawOp implements Iterable<Operand<TType>> {
  ...
  public StagePeek(Operation operation) {
  ...
  public static StagePeek create(Scope scope, Operand<TInt32> index,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "StagePeek");
  ...
  @OpInputsMetadata(
      outputsClass = StagePeek.class
  )
  public static class Inputs extends RawOpInputs<StagePeek> {
    /**
     * The index input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new StagePeek(op), op, Arrays.asList("capacity", "memory_limit", "dtypes", "container", "shared_name"));
      int inputIndex = 0;
