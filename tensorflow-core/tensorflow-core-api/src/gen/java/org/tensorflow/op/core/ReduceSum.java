 ...
 */
@OpMetadata(
    opType = ReduceSum.OP_NAME,
    inputsClass = ReduceSum.Inputs.class
)
@Operator
public final class ReduceSum<T extends TType> extends RawOp implements Operand<T> {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "Sum";

  private Output<T> output;

  public ReduceSum(Operation operation) {
  ...
  public static <T extends TType> ReduceSum<T> create(Scope scope, Operand<T> input,
      Operand<? extends TNumber> axis, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "ReduceSum");
    ...
    return new ReduceSum<>(opBuilder.build());
  }
