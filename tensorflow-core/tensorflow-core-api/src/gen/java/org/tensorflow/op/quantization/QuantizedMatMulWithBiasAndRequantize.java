 ...
 */
public final class QuantizedMatMulWithBiasAndRequantize<W extends Tensor> extends RawOp {
  ...
  public static <W extends Tensor, T extends Tensor, U extends Tensor, V extends Tensor> QuantizedMatMulWithBiasAndRequantize<W> create(Scope scope, Operand<T> a, Operand<U> b, Operand<V> bias, Operand<TFloat32> minA, Operand<TFloat32> maxA, Operand<TFloat32> minB, Operand<TFloat32> maxB, Operand<TFloat32> minFreezedOutput, Operand<TFloat32> maxFreezedOutput, DataType<W> Toutput, Options... options) {
