 ...
 */
public final class CollectiveReduceV3<T extends TNumber> extends RawOp implements Operand<T> {
  /**
   ...
   * @return a new instance of CollectiveReduceV3
   */
  @Endpoint(
      describeByClass = true
  )
  public static <T extends TNumber> CollectiveReduceV3<T> create(Scope scope, Operand<T> input,
      Operand<? extends TType> communicator, Operand<TInt32> groupAssignment, String reduction,
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "CollectiveReduceV3");
    ...
    return new CollectiveReduceV3<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.rawops.CollectiveReduceV3}
   */
  ...
  public static class Inputs<T extends TNumber> extends RawOpInputs<CollectiveReduceV3<T>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new CollectiveReduceV3<>(op), op, Arrays.asList("T", "reduction", "timeout_seconds"));
      int inputIndex = 0;
