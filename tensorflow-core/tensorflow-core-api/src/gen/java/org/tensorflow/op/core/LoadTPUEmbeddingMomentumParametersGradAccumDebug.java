...
public final class LoadTPUEmbeddingMomentumParametersGradAccumDebug extends PrimitiveOp {
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.LoadTPUEmbeddingMomentumParametersGradAccumDebug}
   */
   ...
   */
  public static LoadTPUEmbeddingMomentumParametersGradAccumDebug create(Scope scope, Operand<Float> parameters, Operand<Float> momenta, Operand<Float> gradientAccumulators, Long numShards, Long shardId, Options... options) {
