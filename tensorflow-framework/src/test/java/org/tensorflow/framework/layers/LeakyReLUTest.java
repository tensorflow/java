...
class LeakyReLUTest {
  ...
  public void testCallAlpha0() {
    ...
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      float alpha = 0f;
      LeakyReLU<TFloat32> instance =
          new LeakyReLU<>(
              alpha, TFloat32.class, Layer.Options.create().inputShape(Shape.of(2, 3, 4)));
  ...
  public void testCallAlphaMinus1() {
    ...
    try (TestSession session = TestSession.createTestSession(tfMode)) {
      ...
      float alpha = -1.f;
      LeakyReLU<TFloat64> instance =
          new LeakyReLU<>(
              alpha, TFloat64.class, Layer.Options.create().inputShape(Shape.of(2, 3, 4)));
