 ...
 */
@OpMetadata(
    opType = ReduceProd.OP_NAME,
    inputsClass = ReduceProd.Inputs.class
)
@Operator
public final class ReduceProd<T extends TType> extends RawOp implements Operand<T> {
  /**
  ...
  public ReduceProd(Operation operation) {
  ...
  public static <T extends TType> ReduceProd<T> create(Scope scope, Operand<T> input,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "ReduceProd");
    ...
    return new ReduceProd<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = ReduceProd.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<ReduceProd<T>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new ReduceProd<>(op), op, Arrays.asList("keep_dims", "T", "Tidx"));
      int inputIndex = 0;
