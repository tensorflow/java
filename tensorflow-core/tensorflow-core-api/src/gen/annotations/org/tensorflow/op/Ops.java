...
public final class Ops {
   ...
   */
  public <T extends Number> CudnnRNNCanonicalToParamsV2<T> cudnnRNNCanonicalToParamsV2(
   ...
   */
  public <T extends Number, U extends Number> StatefulRandomBinomial<Long> statefulRandomBinomial(
      Operand<?> resource, Operand<Long> algorithm, Operand<T> shape, Operand<U> counts,
      Operand<U> probs) {
   ...
   */
  public <T extends Number, U extends Number> FusedBatchNormGradV3<T, U> fusedBatchNormGradV3(
   ...
   */
  public <T extends Number, U extends Number> UnsortedSegmentJoin unsortedSegmentJoin(
      Operand<String> inputs, Operand<T> segmentIds, Operand<U> numSegments,
   ...
   */
  public <T extends Number> CudnnRNNParamsToCanonicalV2<T> cudnnRNNParamsToCanonicalV2(
      Operand<Integer> numLayers, Operand<Integer> numUnits, Operand<Integer> inputSize,
   ...
   */
  public <U extends Number, T extends Number> HistogramFixedWidth<U> histogramFixedWidth(
  ...
  public <T> TensorListScatterIntoExistingList tensorListScatterIntoExistingList(
      Operand<?> inputHandle, Operand<T> tensor, Operand<Integer> indices) {
   ...
   */
  public <T, U extends Number> ResourceSparseApplyKerasMomentum resourceSparseApplyKerasMomentum(
   ...
   * @see org.tensorflow.op.core.UniqueWithCounts
   */
  public <T, V extends Number, U extends Number> UniqueWithCounts<T, V> uniqueWithCounts(
   ...
   */
  public <T, U extends Number> TensorStridedSliceUpdate<T> tensorStridedSliceUpdate(
   ...
   * @see org.tensorflow.op.core.StatefulRandomBinomial
   */
  public <V extends Number, T extends Number, U extends Number> StatefulRandomBinomial<V> statefulRandomBinomial(
      Operand<?> resource, Operand<Long> algorithm, Operand<T> shape, Operand<U> counts,
  ...
  /**
   * Creates an API for building operations in the provided environment
   */
