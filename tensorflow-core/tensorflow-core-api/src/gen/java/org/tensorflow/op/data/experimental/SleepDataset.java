...
public final class SleepDataset extends RawOp implements Operand<TType> {
  ...
  public static SleepDataset create(Scope scope, Operand<?> inputDataset, Operand<TInt64> sleepMicroseconds, List<Class<?>> outputTypes, List<Shape> outputShapes) {
    ...
    opBuilder.addInput(sleepMicroseconds.asOutput(scope));
  ...
  public static final String OP_NAME = "ExperimentalSleepDataset";
