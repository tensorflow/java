 ...
 */
public final class LowerBound<U extends Tensor & TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends Tensor & TNumber, T extends Tensor> LowerBound<U> create(Scope scope, Operand<T> sortedInputs, Operand<T> values, DataType<U> outType) {
   ...
   */
  @Endpoint(describeByClass = true)
  public static <T extends Tensor> LowerBound<TInt32> create(Scope scope, Operand<T> sortedInputs, Operand<T> values) {
