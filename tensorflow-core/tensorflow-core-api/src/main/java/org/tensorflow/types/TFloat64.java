 ...
 * 64-bits float type.
 */
public interface TFloat64 extends DoubleNdArray, TDecimal {

  /** Type metadata */
  DataType<TFloat64> DTYPE = DataType.create("FLOAT64", 2, 8, TFloat64Impl::mapTensor);

  /**
   * Allocates a new tensor for storing a double scalar.
   *
  ...
  /**
   * Allocates a new tensor for storing a double vector.
   *
