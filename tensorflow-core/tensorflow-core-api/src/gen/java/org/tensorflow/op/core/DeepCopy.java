 ...
 */
@Operator
public final class DeepCopy<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> DeepCopy<T> create(Scope scope, Operand<T> x) {
