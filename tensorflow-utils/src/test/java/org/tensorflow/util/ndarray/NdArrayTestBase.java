...
import static org.tensorflow.util.ndarray.NdArrays.scalarOf;
import static org.tensorflow.util.ndarray.NdArrays.vectorOfObjects;
import static org.tensorflow.util.ndarray.index.Indices.all;
import static org.tensorflow.util.ndarray.index.Indices.at;
import static org.tensorflow.util.ndarray.index.Indices.even;
import static org.tensorflow.util.ndarray.index.Indices.flip;
import static org.tensorflow.util.ndarray.index.Indices.from;
import static org.tensorflow.util.ndarray.index.Indices.odd;
import static org.tensorflow.util.ndarray.index.Indices.range;
import static org.tensorflow.util.ndarray.index.Indices.seq;
import static org.tensorflow.util.ndarray.index.Indices.to;
