        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              org.tensorflow.proto.framework.FunctionDef m =
                  input.readMessage(
                      org.tensorflow.proto.framework.FunctionDef.parser(),
                      extensionRegistry);
              if (functionBuilder_ == null) {
                ensureFunctionIsMutable();
                function_.add(m);
            ...
            case 18: {
              org.tensorflow.proto.framework.GradientDef m =
                  input.readMessage(
                      org.tensorflow.proto.framework.GradientDef.parser(),
                      extensionRegistry);
              if (gradientBuilder_ == null) {
                ensureGradientIsMutable();
                gradient_.add(m);
            ...
            case 26: {
              org.tensorflow.proto.framework.RegisteredGradient m =
                  input.readMessage(
                      org.tensorflow.proto.framework.RegisteredGradient.parser(),
                      extensionRegistry);
              if (registeredGradientsBuilder_ == null) {
                ensureRegisteredGradientsIsMutable();
