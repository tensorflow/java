 ...
 */
@Operator(group = "math")
public final class Mul<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Mul<T> create(Scope scope, Operand<T> x, Operand<T> y) {
