...
public final class ListSnapshotChunksDataset extends RawOp implements Operand<TType> {
  /**
  ...
  public static ListSnapshotChunksDataset create(Scope scope, Operand<TString> snapshotPath,
  ...
  public static class Inputs extends RawOpInputs<ListSnapshotChunksDataset> {
    /**
     * The snapshotPath input
     */
    public final Operand<TString> snapshotPath;
    ...
    public Inputs(GraphOperation op) {
      ...
      int inputIndex = 0;
      snapshotPath = (Operand<TString>) op.input(inputIndex++);
