...
public final class MapDataset extends RawOp implements Operand<TType> {
   ...
   */
  public static final String OP_NAME = "MapDataset";
  ...
  public static MapDataset create(Scope scope, Operand<? extends TType> inputDataset,
    ...
    OperationBuilder opBuilder = scope.env().opBuilder("MapDataset", scope.makeOpName("MapDataset"));
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.data.MapDataset}
   */
