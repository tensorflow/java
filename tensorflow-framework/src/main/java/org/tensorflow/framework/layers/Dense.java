...
public class Dense<T extends TFloating> extends Layer<T> {
   ...
   */
  public Dense(Integer units, long seed, Class<T> type) {
    this(null, units, null, true, null, null, null, null, null, null, null, seed, type, null);
  }
   ...
   */
  public Dense(Integer units, long seed, Class<T> type, Options options) {
    this(null, units, null, true, null, null, null, null, null, null, null, seed, type, options);
  }
   ...
   * @param type the data type for the weights and computation
   */
  public Dense(String name, Integer units, long seed, Class<T> type) {
    this(name, units, null, true, null, null, null, null, null, null, null, seed, type, null);
  }
   ...
   * @param options the layer's options.
   */
  public Dense(String name, Integer units, long seed, Class<T> type, Options options) {
    this(name, units, null, true, null, null, null, null, null, null, null, seed, type, options);
  }
  ...
  public Dense(
    ...
    this.kernelInitializer =
        kernelInitializer != null
            ? kernelInitializer
            : (Initializer<T>) new Glorot<>(VarianceScaling.Distribution.UNIFORM, seed);
    this.biasInitializer = biasInitializer != null ? biasInitializer : new Zeros<>();
  ...
  public <U extends TType> List<Operand<U>> call(
    ...
    if (activation != null) {
      tOutput = activation.call(getTF(), tOutput);
    }
  ...
  public void build(List<Shape> inputShapes) {
    ...
    if (kernelInitializer == null) {
      ...
      kernelInitializer = new Glorot<>(VarianceScaling.Distribution.UNIFORM, getSeed());
    }
  ...
  /**
   * Applies a constraint to a variable
   *
   * @param variable the variable
   * @return and operand with the variable with applied constaint if one is defined.
   */
  public Operand<T> applyConstraint(Variable<T> variable) {
