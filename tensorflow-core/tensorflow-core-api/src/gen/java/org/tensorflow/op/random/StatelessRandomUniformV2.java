...
public final class StatelessRandomUniformV2<U extends TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends TNumber> StatelessRandomUniformV2<U> create(Scope scope, Operand<? extends TNumber> shape, Operand<?> key, Operand<?> counter, Operand<TInt32> alg, Class<U> dtype) {
   ...
   */
  @Endpoint(describeByClass = true)
  public static StatelessRandomUniformV2<TFloat32> create(Scope scope, Operand<? extends TNumber> shape, Operand<?> key, Operand<?> counter, Operand<TInt32> alg) {
