...
@Operator
public final class MapSize extends RawOp implements Operand<TInt32> {
  /**
  ...
  public static MapSize create(Scope scope, List<Class<? extends TType>> dtypes,
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "MapSize");
  ...
  public static class Inputs extends RawOpInputs<MapSize> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new MapSize(op), op, Arrays.asList("capacity", "memory_limit", "dtypes", "container", "shared_name"));
      int inputIndex = 0;
