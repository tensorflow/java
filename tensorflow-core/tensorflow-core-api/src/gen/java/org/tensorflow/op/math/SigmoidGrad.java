 ...
 */
public final class SigmoidGrad<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> SigmoidGrad<T> create(Scope scope, Operand<T> y, Operand<T> dy) {
