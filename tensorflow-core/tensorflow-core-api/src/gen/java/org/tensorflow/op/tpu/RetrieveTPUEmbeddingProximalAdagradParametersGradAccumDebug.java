 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug";
  ...
  public RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug");
    ...
    return new RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug}
   */
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingProximalAdagradParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
