...
public class AlphaDropout<T extends TFloating> extends Layer<T> {
   ...
   */
  public AlphaDropout(float rate, long seed, Class<T> type, Options options) {
   ...
   * @param options the layer's options.
   */
  public AlphaDropout(float rate, Shape noiseShape, long seed, Class<T> type, Options options) {
