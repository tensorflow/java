 ...
 */
@Operator(group = "math")
public final class MulNoNan<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> MulNoNan<T> create(Scope scope, Operand<T> x, Operand<T> y) {
