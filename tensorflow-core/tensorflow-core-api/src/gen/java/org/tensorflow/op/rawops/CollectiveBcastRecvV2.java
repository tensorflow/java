 ...
 */
@OpMetadata(
    opType = CollectiveBcastRecvV2.OP_NAME,
    inputsClass = CollectiveBcastRecvV2.Inputs.class
)
public final class CollectiveBcastRecvV2<U extends TType> extends RawOp implements Operand<U> {
  ...
  public CollectiveBcastRecvV2(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = CollectiveBcastRecvV2.class
  )
