...
public final class XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize extends RawOp {
  ...
  public static class Inputs extends RawOpInputs<XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize> {
    ...
    public Inputs(GraphOperation op) {
      super(new XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize(op), op, Arrays.asList("clip_weight_min", "clip_weight_max", "max_ids_per_sparse_core", "max_unique_ids_per_sparse_core", "table_name"));
      int inputIndex = 0;
