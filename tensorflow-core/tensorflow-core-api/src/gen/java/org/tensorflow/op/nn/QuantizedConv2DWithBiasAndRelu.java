 ...
 */
@OpMetadata(
    opType = QuantizedConv2DWithBiasAndRelu.OP_NAME,
    inputsClass = QuantizedConv2DWithBiasAndRelu.Inputs.class
)
public final class QuantizedConv2DWithBiasAndRelu<V extends TNumber> extends RawOp {
  /**
  ...
  public QuantizedConv2DWithBiasAndRelu(Operation operation) {
  ...
  public static <V extends TNumber> QuantizedConv2DWithBiasAndRelu<V> create(Scope scope,
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedConv2DWithBiasAndRelu");
    ...
    return new QuantizedConv2DWithBiasAndRelu<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.nn.QuantizedConv2DWithBiasAndRelu}
   */
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedConv2DWithBiasAndRelu.class
  )
  public static class Inputs extends RawOpInputs<QuantizedConv2DWithBiasAndRelu<?>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedConv2DWithBiasAndRelu<>(op), op, Arrays.asList("Tinput", "Tfilter", "out_type", "strides", "padding", "dilations", "padding_list"));
      int inputIndex = 0;
