 ...
 */
@OpMetadata(
    opType = DataServiceDatasetV3.OP_NAME,
    inputsClass = DataServiceDatasetV3.Inputs.class
)
public final class DataServiceDatasetV3 extends RawOp implements Operand<TType> {
  /**
  ...
  public DataServiceDatasetV3(Operation operation) {
   ...
   * @return a new instance of DataServiceDatasetV3
   */
  @Endpoint(
      describeByClass = true
  )
  public static DataServiceDatasetV3 create(Scope scope, Operand<TInt64> datasetId,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "DataServiceDatasetV3");
    ...
    return new DataServiceDatasetV3(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = DataServiceDatasetV3.class
  )
  public static class Inputs extends RawOpInputs<DataServiceDatasetV3> {
    /**
     * The datasetId input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new DataServiceDatasetV3(op), op, Arrays.asList("task_refresh_interval_hint_ms", "output_types", "output_shapes", "data_transfer_protocol", "target_workers", "uncompress"));
      int inputIndex = 0;
