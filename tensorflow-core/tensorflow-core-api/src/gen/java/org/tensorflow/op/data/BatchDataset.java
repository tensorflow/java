...
public final class BatchDataset extends RawOp implements Operand<TType> {
  ...
  public static BatchDataset create(Scope scope, Operand<?> inputDataset, Operand<TInt64> batchSize, Operand<TBool> dropRemainder, List<Class<?>> outputTypes, List<Shape> outputShapes, Options... options) {
