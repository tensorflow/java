...
public final class ResourceApplyKerasMomentum extends RawOp {
  ...
  public static <T extends Tensor> ResourceApplyKerasMomentum create(Scope scope, Operand<?> var, Operand<?> accum, Operand<T> lr, Operand<T> grad, Operand<T> momentum, Options... options) {
