 ...
 */
@OpMetadata(
    opType = ReduceMin.OP_NAME,
    inputsClass = ReduceMin.Inputs.class
)
@Operator
public final class ReduceMin<T extends TNumber> extends RawOp implements Operand<T> {
  /**
  ...
  public ReduceMin(Operation operation) {
  ...
  public static <T extends TNumber> ReduceMin<T> create(Scope scope, Operand<T> input,
    ...
    return new ReduceMin<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = ReduceMin.class
  )
  public static class Inputs<T extends TNumber> extends RawOpInputs<ReduceMin<T>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new ReduceMin<>(op), op, Arrays.asList("keep_dims", "T", "Tidx"));
      int inputIndex = 0;
