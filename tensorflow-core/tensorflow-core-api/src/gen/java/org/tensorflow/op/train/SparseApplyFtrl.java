...
public final class SparseApplyFtrl<T extends TType> extends RawOp implements Operand<T> {
  ...
  public static <T extends TType> SparseApplyFtrl<T> create(Scope scope, Operand<T> var,
    ...
    return new SparseApplyFtrl<>(opBuilder.build());
  }
  ...
  public static class Inputs<T extends TType> extends RawOpInputs<SparseApplyFtrl<T>> {
    ...
    public Inputs(GraphOperation op) {
      super(new SparseApplyFtrl<>(op), op, Arrays.asList("T", "Tindices", "use_locking", "multiply_linear_by_lr"));
      int inputIndex = 0;
