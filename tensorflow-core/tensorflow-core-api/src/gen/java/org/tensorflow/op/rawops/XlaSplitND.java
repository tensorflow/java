 ...
 */
public final class XlaSplitND<T extends TType> extends RawOp implements Iterable<Operand<T>> {
  /**
  ...
  private XlaSplitND(Operation operation) {
    super(operation);
    int outputIdx = 0;
   ...
   * @return a new instance of XlaSplitND
   */
  @Endpoint(
      describeByClass = true
  )
  public static <T extends TType> XlaSplitND<T> create(Scope scope, Operand<T> input, Long N,
      List<Long> numSplits, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "XlaSplitND");
    ...
    return new XlaSplitND<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.rawops.XlaSplitND}
   */
  ...
  public static class Inputs<T extends TType> extends RawOpInputs<XlaSplitND<T>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new XlaSplitND<>(op), op, Arrays.asList("T", "num_splits", "paddings"));
      int inputIndex = 0;
