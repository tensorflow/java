 ...
 */
@OpMetadata(
    opType = RetrieveTPUEmbeddingMomentumParametersGradAccumDebug.OP_NAME,
    inputsClass = RetrieveTPUEmbeddingMomentumParametersGradAccumDebug.Inputs.class
)
public final class RetrieveTPUEmbeddingMomentumParametersGradAccumDebug extends RawOp {
  ...
  public RetrieveTPUEmbeddingMomentumParametersGradAccumDebug(Operation operation) {
  ...
  public static RetrieveTPUEmbeddingMomentumParametersGradAccumDebug create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RetrieveTPUEmbeddingMomentumParametersGradAccumDebug");
  ...
  @OpInputsMetadata(
      outputsClass = RetrieveTPUEmbeddingMomentumParametersGradAccumDebug.class
  )
  public static class Inputs extends RawOpInputs<RetrieveTPUEmbeddingMomentumParametersGradAccumDebug> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new RetrieveTPUEmbeddingMomentumParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
