 ...
 */
@Operator
public final class Size<U extends Tensor & TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends Tensor & TNumber, T extends Tensor> Size<U> create(Scope scope, Operand<T> input, DataType<U> outType) {
   ...
   */
  @Endpoint(describeByClass = true)
  public static <T extends Tensor> Size<TInt32> create(Scope scope, Operand<T> input) {
