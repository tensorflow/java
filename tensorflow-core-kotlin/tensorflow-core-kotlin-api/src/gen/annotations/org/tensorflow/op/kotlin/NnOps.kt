...
public class NnOps(
     ...
     * @param useCudnnOnGpu @param useCudnnOnGpu
     ...
     * @param dataFormat @param dataFormat
     */
     ...
     * @param explicitPaddings @param explicitPaddings
     * @param dataFormat Specify the data format of the input and output data. With the
     *  default format "NHWC", the data is stored in the order of:
     *      &#91;batch, height, width, channels].
     *  Alternatively, the format could be "NCHW", the data storage order of:
     ...
     * @param exponentialAvgFactor @param exponentialAvgFactor
    ...
    public inline fun <reified U : TNumber, reified T : TNumber> cudnnRnnParamsSize(
        ...
        seed2: Long? = null,
        numProj: Long? = null
    ): CudnnRnnParamsSize<U> = cudnnRnnParamsSize<U, T>(
