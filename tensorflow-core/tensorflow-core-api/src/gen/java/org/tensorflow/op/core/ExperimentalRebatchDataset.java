...
public final class ExperimentalRebatchDataset extends PrimitiveOp implements Operand<Object> {
   ...
   * @return a new instance of ExperimentalRebatchDataset
   */
  public static ExperimentalRebatchDataset create(Scope scope, Operand<?> inputDataset, Operand<TInt64> numReplicas, List<DataType<?>> outputTypes, List<Shape> outputShapes, Options... options) {
