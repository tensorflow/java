...
public final class DatasetFingerprint extends RawOp implements Operand<TType> {
  /**
  ...
  public Output<TType> asOutput() {
    return (Output<TType>) fingerprint;
  }

  @OpInputsMetadata(
      outputsClass = DatasetFingerprint.class
  )
  public static class Inputs extends RawOpInputs<DatasetFingerprint> {
    /**
