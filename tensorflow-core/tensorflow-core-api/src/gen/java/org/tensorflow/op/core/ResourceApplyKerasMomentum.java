...
public final class ResourceApplyKerasMomentum extends PrimitiveOp {
   ...
   */
  public static <T> ResourceApplyKerasMomentum create(Scope scope, Operand<?> var, Operand<?> accum, Operand<T> lr, Operand<T> grad, Operand<T> momentum, Options... options) {
