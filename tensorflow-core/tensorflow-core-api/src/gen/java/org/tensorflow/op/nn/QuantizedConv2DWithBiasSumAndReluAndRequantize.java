 ...
 */
@OpMetadata(
    opType = QuantizedConv2DWithBiasSumAndReluAndRequantize.OP_NAME,
    inputsClass = QuantizedConv2DWithBiasSumAndReluAndRequantize.Inputs.class
)
public final class QuantizedConv2DWithBiasSumAndReluAndRequantize<X extends TNumber> extends RawOp {
  /**
  ...
  public QuantizedConv2DWithBiasSumAndReluAndRequantize(Operation operation) {
  ...
  public static <X extends TNumber> QuantizedConv2DWithBiasSumAndReluAndRequantize<X> create(
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedConv2DWithBiasSumAndReluAndRequantize");
    ...
    return new QuantizedConv2DWithBiasSumAndReluAndRequantize<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedConv2DWithBiasSumAndReluAndRequantize.class
  )
  public static class Inputs extends RawOpInputs<QuantizedConv2DWithBiasSumAndReluAndRequantize<?>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedConv2DWithBiasSumAndReluAndRequantize<>(op), op, Arrays.asList("Tinput", "Tfilter", "Tbias", "Tsummand", "out_type", "strides", "padding", "dilations", "padding_list"));
      int inputIndex = 0;
