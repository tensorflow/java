 ...
 */
@OpMetadata(
    opType = QuantizedConv2DWithBias.OP_NAME,
    inputsClass = QuantizedConv2DWithBias.Inputs.class
)
public final class QuantizedConv2DWithBias<V extends TNumber> extends RawOp {
  /**
  ...
  public QuantizedConv2DWithBias(Operation operation) {
  ...
  public static <V extends TNumber> QuantizedConv2DWithBias<V> create(Scope scope,
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "QuantizedConv2DWithBias");
    ...
    return new QuantizedConv2DWithBias<>(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = QuantizedConv2DWithBias.class
  )
  public static class Inputs extends RawOpInputs<QuantizedConv2DWithBias<?>> {
    /**
     * The input input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new QuantizedConv2DWithBias<>(op), op, Arrays.asList("Tinput", "Tfilter", "out_type", "strides", "padding", "dilations", "padding_list"));
      int inputIndex = 0;
