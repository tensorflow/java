...
public final class LeftShift<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> LeftShift<T> create(Scope scope, Operand<T> x, Operand<T> y) {
