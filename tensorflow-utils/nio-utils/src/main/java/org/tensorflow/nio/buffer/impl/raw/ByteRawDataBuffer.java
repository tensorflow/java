...
public final class ByteRawDataBuffer extends AbstractRawDataBuffer<Byte, ByteDataBuffer>
  ...
  public static ByteDataBuffer wrap(byte[] array, boolean readOnly) {
    return new ByteRawDataBuffer(UnsafeMemoryHandle.of(UNSAFE, array), readOnly);
  }

  public static ByteDataBuffer map(Unsafe unsafe, long address, long size, boolean readOnly) {
