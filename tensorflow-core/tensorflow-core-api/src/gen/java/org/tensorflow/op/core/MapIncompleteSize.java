...
public final class MapIncompleteSize extends RawOp implements Operand<TInt32> {
  ...
  public static MapIncompleteSize create(Scope scope, List<Class<? extends TType>> dtypes,
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "MapIncompleteSize");
  ...
  public static class Inputs extends RawOpInputs<MapIncompleteSize> {
    ...
    public Inputs(GraphOperation op) {
      super(new MapIncompleteSize(op), op, Arrays.asList("capacity", "memory_limit", "dtypes", "container", "shared_name"));
      int inputIndex = 0;
