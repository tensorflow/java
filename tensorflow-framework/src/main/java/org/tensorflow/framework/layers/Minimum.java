...
public class Minimum<T extends TFloating> extends Merge<T> {
   ...
   */
  public Minimum(Class<T> type, Options options) {
   ...
   * @param type the data type for the weights and computation
   */
  public Minimum(String name, Class<T> type) {
    this(name, type, null);
  }
   ...
   * @param options the layer's options.
   */
  public Minimum(String name, Class<T> type, Options options) {
