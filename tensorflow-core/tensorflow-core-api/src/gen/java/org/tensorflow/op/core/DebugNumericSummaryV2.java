 ...
 */
public final class DebugNumericSummaryV2<U extends TNumber> extends RawOp implements Operand<U> {
  ...
  public static <U extends TNumber, T extends TType> DebugNumericSummaryV2<U> create(Scope scope, Operand<T> input, DataType<U> outputDtype, Options... options) {
    ...
    return new DebugNumericSummaryV2<U>(opBuilder.build());
  }
  
  /**
   * Factory method to create a class wrapping a new DebugNumericSummaryV2 operation using default output types.
   * 
   * @param scope current scope
   * @param input Input tensor, to be summarized by the op.
   * @param options carries optional attributes values
   ...
   */
  @Endpoint(describeByClass = true)
  public static <T extends TType> DebugNumericSummaryV2<TFloat32> create(Scope scope, Operand<T> input, Options... options) {
