...
public final class Rfft2d extends PrimitiveOp implements Operand<TType> {
   ...
   */
  public static Rfft2d create(Scope scope, Operand<TFloat32> input, Operand<TInt32> fftLength) {
