...
public final class QuantizedConv2DWithBiasAndRequantize<W> extends PrimitiveOp {
   ...
   */
  public static <W, T, U, V> QuantizedConv2DWithBiasAndRequantize<W> create(Scope scope, Operand<T> input, Operand<U> filter, Operand<V> bias, Operand<Float> minInput, Operand<Float> maxInput, Operand<Float> minFilter, Operand<Float> maxFilter, Operand<Float> minFreezedOutput, Operand<Float> maxFreezedOutput, Class<W> outType, List<Long> strides, String padding, Options... options) {
