...
public final class PrefetchDataset extends RawOp implements Operand<TType> {
  ...
  public static PrefetchDataset create(Scope scope, Operand<?> inputDataset, Operand<TInt64> bufferSize, List<Class<?>> outputTypes, List<Shape> outputShapes, Options... options) {
