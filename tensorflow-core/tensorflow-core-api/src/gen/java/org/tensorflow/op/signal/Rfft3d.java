 ...
 */
@OpMetadata(
    opType = Rfft3d.OP_NAME,
    inputsClass = Rfft3d.Inputs.class
)
@Operator(
    group = "signal"
)
public final class Rfft3d<U extends TType> extends RawOp implements Operand<U> {
  ...
  public Rfft3d(Operation operation) {
  ...
  public static <U extends TType> Rfft3d<U> create(Scope scope, Operand<? extends TNumber> input,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "Rfft3d");
  ...
  @OpInputsMetadata(
      outputsClass = Rfft3d.class
  )
  public static class Inputs extends RawOpInputs<Rfft3d<?>> {
    /**
     * A float32 tensor.
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Rfft3d<>(op), op, Arrays.asList("Treal", "Tcomplex"));
      int inputIndex = 0;
