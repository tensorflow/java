...
public final class DataBuffers {
  ...
  public static ByteDataBuffer ofBytes(long size) {
    return UnsafeReference.isAvailableInternally() ? ByteRawDataBuffer.allocate(size) : ByteJdkDataBuffer
        .allocate(size);
  }
  ...
  public static LongDataBuffer ofLongs(long size) {
    return UnsafeReference.isAvailableInternally() ? LongRawDataBuffer.allocate(size) : LongJdkDataBuffer
        .allocate(size);
  }
  ...
  public static IntDataBuffer ofInts(long size) {
    return UnsafeReference.isAvailableInternally() ? IntRawDataBuffer.allocate(size) : IntJdkDataBuffer
        .allocate(size);
  }
  ...
  public static ShortDataBuffer ofShorts(long size) {
    return UnsafeReference.isAvailableInternally() ? ShortRawDataBuffer.allocate(size) : ShortJdkDataBuffer
        .allocate(size);
  }
  ...
  public static DoubleDataBuffer ofDoubles(long size) {
    return UnsafeReference.isAvailableInternally() ? DoubleRawDataBuffer.allocate(size) : DoubleJdkDataBuffer
        .allocate(size);
  }
