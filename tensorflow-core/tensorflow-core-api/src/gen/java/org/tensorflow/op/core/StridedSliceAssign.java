 ...
 */
@Operator
public final class StridedSliceAssign<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor, U extends Tensor & TNumber> StridedSliceAssign<T> create(Scope scope, Operand<T> ref, Operand<U> begin, Operand<U> end, Operand<U> strides, Operand<T> value, Options... options) {
