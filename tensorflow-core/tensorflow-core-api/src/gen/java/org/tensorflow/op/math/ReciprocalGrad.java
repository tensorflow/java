 ...
 */
public final class ReciprocalGrad<T extends TType> extends PrimitiveOp implements Operand<T> {
  ...
  public static <T extends TType> ReciprocalGrad<T> create(Scope scope, Operand<T> y, Operand<T> dy) {
