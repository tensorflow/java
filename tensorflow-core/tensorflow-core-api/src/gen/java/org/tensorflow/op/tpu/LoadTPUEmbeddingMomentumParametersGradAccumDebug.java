...
public final class LoadTPUEmbeddingMomentumParametersGradAccumDebug extends RawOp {
   ...
   * @param gradientAccumulators Value of gradient_accumulators used in the Momentum optimization algorithm.
  ...
  public static LoadTPUEmbeddingMomentumParametersGradAccumDebug create(Scope scope,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "LoadTPUEmbeddingMomentumParametersGradAccumDebug");
    ...
    return new LoadTPUEmbeddingMomentumParametersGradAccumDebug(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.tpu.LoadTPUEmbeddingMomentumParametersGradAccumDebug}
   */
  ...
  public static class Inputs extends RawOpInputs<LoadTPUEmbeddingMomentumParametersGradAccumDebug> {
    ...
    public Inputs(GraphOperation op) {
      super(new LoadTPUEmbeddingMomentumParametersGradAccumDebug(op), op, Arrays.asList("table_id", "table_name", "num_shards", "shard_id", "config"));
      int inputIndex = 0;
