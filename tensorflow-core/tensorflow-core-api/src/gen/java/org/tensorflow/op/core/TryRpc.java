 ...
 */
@Operator
public final class TryRpc extends RawOp {
  /**
  ...
  public static TryRpc create(Scope scope, Operand<TString> address, Operand<TString> method,
  ...
  /**
   * Gets statusCode.
   * Same shape as {@code request}.  Values correspond to tensorflow Status enum codes.
   * @return statusCode.
   */
  ...
  /**
   * Gets statusMessage.
   * Same shape as {@code request}.  Values correspond to Status messages
