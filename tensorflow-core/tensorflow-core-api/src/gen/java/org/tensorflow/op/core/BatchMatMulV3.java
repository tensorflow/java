 ...
 */
@Operator
public final class BatchMatMulV3<V extends TType> extends RawOp implements Operand<V> {
  /**
  ...
  private BatchMatMulV3(Operation operation) {
    super(operation);
    int outputIdx = 0;
  ...
  public static <V extends TType> BatchMatMulV3<V> create(Scope scope, Operand<? extends TType> x,
      Operand<? extends TType> y, Class<V> Tout, Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "BatchMatMulV3");
    ...
    return new BatchMatMulV3<>(opBuilder.build());
  }
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.core.BatchMatMulV3}
   */
