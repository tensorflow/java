...
public class Subtract<T extends TFloating> extends Merge<T> {
   ...
   */
  public Subtract(Class<T> type, Options options) {
   ...
   * @param type the data type for the weights and computation
   */
  public Subtract(String name, Class<T> type) {
    this(name, type, null);
  }
   ...
   * @param options the layer's options.
   */
  public Subtract(String name, Class<T> type, Options options) {
