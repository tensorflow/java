 ...
 */
@Operator
public final class XlaRngBitGenerator<U extends TNumber> extends RawOp {
  /**
  ...
  private XlaRngBitGenerator(Operation operation) {
    super(operation);
    int outputIdx = 0;
  ...
  public static class Inputs extends RawOpInputs<XlaRngBitGenerator<?>> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new XlaRngBitGenerator<>(op), op, Arrays.asList("dtype", "Tshape"));
      int inputIndex = 0;
