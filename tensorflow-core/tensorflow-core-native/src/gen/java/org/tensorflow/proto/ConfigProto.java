...
private static final long serialVersionUID = 0L;
  ...
  public interface ExperimentalOrBuilder extends
     ...
     * </pre>
     *
     * <code>string tf2xla_dump_dir = 35;</code>
     * @return The tf2xlaDumpDir.
     */
    java.lang.String getTf2XlaDumpDir();
    /**
     * <pre>
     * If set, TF2XLA will dump compilation call arguments to the specified
     * directory.
     ...
     *
     * <code>string tf2xla_dump_dir = 35;</code>
     * @return The bytes for tf2xlaDumpDir.
     */
    com.google.protobuf.ByteString
        getTf2XlaDumpDirBytes();
     ...
     * </pre>
     *
     * <code>bool online_cost_analysis = 36;</code>
     * @return The onlineCostAnalysis.
     */
    boolean getOnlineCostAnalysis();
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
     ...
     */
    @java.lang.Override
    public java.lang.String getTf2XlaDumpDir() {
      java.lang.Object ref = tf2XlaDumpDir_;
      if (ref instanceof java.lang.String) {
        return (java.lang.String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public static final int ONLINE_COST_ANALYSIS_FIELD_NUMBER = 36;
    private boolean onlineCostAnalysis_ = false;
    /**
     * <pre>
     * When set to true, the online op cost analysis will be enabled. This
     * will run the cost analysis once for the first model execution and
     ...
     */
    @java.lang.Override
    public boolean getOnlineCostAnalysis() {
      return onlineCostAnalysis_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tf2XlaDumpDir_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 35, tf2XlaDumpDir_);
      }
      if (onlineCostAnalysis_ != false) {
        output.writeBool(36, onlineCostAnalysis_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tf2XlaDumpDir_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(35, tf2XlaDumpDir_);
      }
      if (onlineCostAnalysis_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(36, onlineCostAnalysis_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getTf2XlaDumpDir()
          .equals(other.getTf2XlaDumpDir())) return false;
      if (getOnlineCostAnalysis()
          != other.getOnlineCostAnalysis()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + TF2XLA_DUMP_DIR_FIELD_NUMBER;
      hash = (53 * hash) + getTf2XlaDumpDir().hashCode();
      hash = (37 * hash) + ONLINE_COST_ANALYSIS_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getOnlineCostAnalysis());
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(org.tensorflow.proto.ConfigProto.Experimental result) {
        ...
        if (((from_bitField0_ & 0x40000000) != 0)) {
          result.tf2XlaDumpDir_ = tf2XlaDumpDir_;
        }
        if (((from_bitField0_ & 0x80000000) != 0)) {
          result.onlineCostAnalysis_ = onlineCostAnalysis_;
        }
      ...
      public Builder mergeFrom(org.tensorflow.proto.ConfigProto.Experimental other) {
        ...
        if (!other.getTf2XlaDumpDir().isEmpty()) {
          tf2XlaDumpDir_ = other.tf2XlaDumpDir_;
          bitField0_ |= 0x40000000;
          onChanged();
        }
        if (other.getOnlineCostAnalysis() != false) {
          setOnlineCostAnalysis(other.getOnlineCostAnalysis());
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 186: {
                input.readMessage(
                    internalGetCoordinationConfigFieldBuilder().getBuilder(),
                    extensionRegistry);
              ...
              case 282: {
                tf2XlaDumpDir_ = input.readStringRequireUtf8();
                bitField0_ |= 0x40000000;
                break;
              } // case 282
              case 288: {
                onlineCostAnalysis_ = input.readBool();
       ...
       *
       * <code>string tf2xla_dump_dir = 35;</code>
       * @param value The tf2xlaDumpDir to set.
       * @return This builder for chaining.
       */
      public Builder setTf2XlaDumpDir(
          java.lang.String value) {
        if (value == null) { throw new NullPointerException(); }
        tf2XlaDumpDir_ = value;
        bitField0_ |= 0x40000000;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearTf2XlaDumpDir() {
        tf2XlaDumpDir_ = getDefaultInstance().getTf2XlaDumpDir();
       ...
       *
       * <code>string tf2xla_dump_dir = 35;</code>
       * @param value The bytes for tf2xlaDumpDir to set.
       * @return This builder for chaining.
       */
      public Builder setTf2XlaDumpDirBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        tf2XlaDumpDir_ = value;
      ...
      private boolean onlineCostAnalysis_ ;
      /**
       * <pre>
       * When set to true, the online op cost analysis will be enabled. This
       * will run the cost analysis once for the first model execution and
       ...
       *
       * <code>bool online_cost_analysis = 36;</code>
       * @param value The onlineCostAnalysis to set.
       * @return This builder for chaining.
       */
      public Builder setOnlineCostAnalysis(boolean value) {

        onlineCostAnalysis_ = value;
        bitField0_ |= 0x80000000;
        onChanged();
        return this;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder clearOnlineCostAnalysis() {
  ...
  public static final class Builder extends
          ...
          if (sessionInterOpThreadPoolBuilder_.isEmpty()) {
            ...
            sessionInterOpThreadPoolBuilder_ = 
              com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                 internalGetSessionInterOpThreadPoolFieldBuilder() : null;
          } else {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50: {
              input.readMessage(
                  internalGetGpuOptionsFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000080;
              break;
            } // case 50
            ...
            case 82: {
              input.readMessage(
                  internalGetGraphOptionsFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000800;
              break;
            } // case 82
            ...
            case 106: {
              input.readMessage(
                  internalGetRpcOptionsFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00002000;
              break;
            } // case 106
            case 114: {
              input.readMessage(
                  internalGetClusterDefFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00004000;
              break;
            } // case 114
            ...
            case 146: {
              input.readMessage(
                  internalGetPluggableDeviceOptionsFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000100;
              break;
            } // case 146
    ...
    public org.tensorflow.proto.ThreadPoolOptionProto.Builder getSessionInterOpThreadPoolBuilder(
        int index) {
      return internalGetSessionInterOpThreadPoolFieldBuilder().getBuilder(index);
    }
    /**
     * <pre>
     * This option is experimental - it may be replaced with a different mechanism
