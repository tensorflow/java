...
public final class RgbToHsv<T extends Tensor & TNumber> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor & TNumber> RgbToHsv<T> create(Scope scope, Operand<T> images) {
