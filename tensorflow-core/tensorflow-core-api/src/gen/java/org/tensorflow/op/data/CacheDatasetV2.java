...
/**
 */
public final class CacheDatasetV2 extends RawOp implements Operand<TType> {
  ...
  public static CacheDatasetV2 create(Scope scope, Operand<?> inputDataset, Operand<TString> filename, Operand<?> cache, List<Class<?>> outputTypes, List<Shape> outputShapes) {
    ...
    opBuilder.addInput(cache.asOutput(scope));
    ...
    return new CacheDatasetV2(opBuilder.build());
  }
