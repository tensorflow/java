 ...
 */
@Operator
public final class Empty<T extends Tensor> extends RawOp implements Operand<T> {
  ...
  public static <T extends Tensor> Empty<T> create(Scope scope, Operand<TInt32> shape, DataType<T> dtype, Options... options) {
