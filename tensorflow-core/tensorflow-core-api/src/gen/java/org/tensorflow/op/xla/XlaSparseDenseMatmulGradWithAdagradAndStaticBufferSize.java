...
/**
 * The XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize operation
 */
@OpMetadata(
    opType = XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize.OP_NAME,
    inputsClass = XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize.Inputs.class
)
public final class XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize extends RawOp {
  /**
   * The name of this op, as known by TensorFlow core engine
   */
  public static final String OP_NAME = "XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize";

  private Output<TFloat32> updatedEmbeddingTable;

  private Output<TFloat32> updatedAccumulator;

  public XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize(Operation operation) {
  ...
  /**
   * Factory method to create a class wrapping a new XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize operation.
   *
   ...
   * @return a new instance of XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize
   */
  @Endpoint(
      describeByClass = true
  )
  public static XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize create(Scope scope,
      ...
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize");
    ...
    return new XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize(opBuilder.build());
  }
  ...
  @OpInputsMetadata(
      outputsClass = XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize.class
  )
  public static class Inputs extends RawOpInputs<XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new XlaSparseDenseMatmulGradWithAdagradAndStaticBufferSize(op), op, Arrays.asList("clip_weight_min", "clip_weight_max", "max_ids_per_sparse_core", "max_unique_ids_per_sparse_core", "table_name", "num_sparsecores_per_device"));
      int inputIndex = 0;
