 ...
 */
@OpMetadata(
    opType = StageSize.OP_NAME,
    inputsClass = StageSize.Inputs.class
)
@Operator
public final class StageSize extends RawOp implements Operand<TInt32> {
  ...
  public StageSize(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = StageSize.class
  )
  public static class Inputs extends RawOpInputs<StageSize> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new StageSize(op), op, Arrays.asList("capacity", "memory_limit", "dtypes", "container", "shared_name"));
      int inputIndex = 0;
