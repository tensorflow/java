...
public final class Any extends RawOp implements Operand<TBool> {
  ...
  public static Any create(Scope scope, Operand<TBool> input, Operand<? extends TNumber> axis,
      Options... options) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "Any");
  ...
  public static class Inputs extends RawOpInputs<Any> {
    /**
    ...
    public Inputs(GraphOperation op) {
      super(new Any(op), op, Arrays.asList("keep_dims", "Tidx"));
      int inputIndex = 0;
