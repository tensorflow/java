...
public final class DecodeAndCropJpeg extends RawOp implements Operand<TUint8> {
  /**
  ...
  public static DecodeAndCropJpeg create(Scope scope, Operand<TString> contents,
    ...
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "DecodeAndCropJpeg");
  ...
  public static class Inputs extends RawOpInputs<DecodeAndCropJpeg> {
    ...
    public Inputs(GraphOperation op) {
      ...
      cropWindow = (Operand<TInt32>) op.input(inputIndex++);
