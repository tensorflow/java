...
public final class RiscCos<T extends TNumber> extends RawOp implements Operand<T> {
   ...
   */
  public static final String OP_NAME = "RiscCos";
  ...
  /**
   * Factory method to create a class wrapping a new RiscCos operation.
   *
  ...
  public static <T extends TNumber> RiscCos<T> create(Scope scope, Operand<T> x) {
    OperationBuilder opBuilder = scope.opBuilder(OP_NAME, "RiscCos");
    opBuilder.addInput(x.asOutput());
    return new RiscCos<>(opBuilder.build());
  }
  ...
  public static class Inputs<T extends TNumber> extends RawOpInputs<RiscCos<T>> {
    ...
    public Inputs(GraphOperation op) {
      super(new RiscCos<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
