...
public final class ScanDataset extends RawOp implements Operand<TType> {
   ...
   */
  public static final String OP_NAME = "ExperimentalScanDataset";
  ...
  /**
   * Optional attributes for {@link org.tensorflow.op.data.experimental.ScanDataset}
   */
  ...
  public static class Inputs extends RawOpInputs<ScanDataset> {
    ...
    public Inputs(GraphOperation op) {
      super(new ScanDataset(op), op, Arrays.asList("Tstate", "Targuments", "output_types", "output_shapes", "preserve_cardinality"));
      int inputIndex = 0;
