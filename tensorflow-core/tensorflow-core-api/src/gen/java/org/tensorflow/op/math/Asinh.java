...
@OpMetadata(
    ...
    inputsClass = Asinh.Inputs.class
)
@Operator(
    group = "math"
)
public final class Asinh<T extends TType> extends RawOp implements Operand<T> {
  ...
  public Asinh(Operation operation) {
  ...
  @OpInputsMetadata(
      outputsClass = Asinh.class
  )
  public static class Inputs<T extends TType> extends RawOpInputs<Asinh<T>> {
    /**
     * The x input
     */
    ...
    public Inputs(GraphOperation op) {
      super(new Asinh<>(op), op, Arrays.asList("T"));
      int inputIndex = 0;
